...
def setUpModule():
    global mol_sph, mol_cart, mol2, mol1sph, mol1cart
    atom = '''
...
'''
    ...
    mol_sph = pyscf.M(atom=atom, basis=bas, output='/dev/null')

    mol_cart = pyscf.M(atom=atom, basis=bas, cart=1,
                       output='/dev/null')

    mol1sph = pyscf.M(atom=atom, basis='def2-svp', output='/dev/null')
    mol1cart = pyscf.M(atom=atom, basis='def2-svp', output='/dev/null')
...
def tearDownModule():
    ...
    mol1sph.stdout.close()
    mol1cart.stdout.close()
    mol2.stdout.close()
    del mol_sph, mol_cart, mol2, mol1sph, mol1cart
