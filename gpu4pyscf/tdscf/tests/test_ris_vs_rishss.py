...
from gpu4pyscf.tdscf import ris_hss
...
class KnownValues(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.mf_pbe = rks.RKS(mol, xc='pbe').to_gpu().run()
        cls.mf_pbe0 = rks.RKS(mol, xc='pbe0').to_gpu().run()
    ...
    def test_tda_pbe(self):
        ...
        td_hss = mf.TDA_ris()
        td_hss.nstates=self.nstates
        td_hss.kernel()
        self.assertAlmostEqual(abs(energies - td_hss.e).max(), 0, PLACES)
...
if __name__ == "__main__":
    print("Full Tests for another TDDFT-RIS by zhichen.")
    unittest.main()