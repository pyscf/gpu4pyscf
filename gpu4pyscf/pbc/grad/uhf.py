...
class Gradients(rhf.GradientsBase, mol_uhf.Gradients, cpu_uhf.Gradients):
    ...
    def grad_elec(
        ...
        dme0_combined_spin = dme0[0] + dme0[1]
        ...
        de -= mf.with_df.get_ovlp_ip1(dme0_combined_spin, kpts=kpts)
