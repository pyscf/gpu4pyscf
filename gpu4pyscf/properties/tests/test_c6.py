...
class KnownValues(unittest.TestCase):
    ...
    def test_calc_c6_sanity(self):
        ...
        ref_xy00 = np.array([[-1.30075599e-19+0.j, -2.46394827e-19+0.j, -3.57511290e-04+0.j,
                               1.42099094e-04+0.j, -1.98997006e-18+0.j, -1.06832685e-18+0.j,],
                             [ 2.56736352e-17+0.j, -1.17104742e-16+0.j, -6.39696159e-03+0.j,
                               2.54258390e-03+0.j, -1.13781911e-17+0.j,  1.70629105e-17+0.j,],
                             [ 9.53668504e-17+0.j, -1.18018049e-17+0.j,  8.06800482e-04+0.j,
                              -3.20676916e-04+0.j, -1.06770074e-16+0.j, -6.52977336e-17+0.j,],
                             [-1.42687004e-02+0.j, -2.33084878e-04+0.j,  1.95665208e-16+0.j,
                               3.91504715e-17+0.j,  6.51825685e-05+0.j, -1.14309878e-04+0.j,],
                             [-7.06986911e-01+0.j, -1.15489115e-02+0.j, -1.07407259e-16+0.j,
                              -4.32672497e-17+0.j,  3.22967203e-03+0.j, -5.66383657e-03+0.j,],])
        ...
        self.assertAlmostEqual(abs(td.xy[0][0] - ref_xy00).max(), 0, 6)
        self.assertAlmostEqual(val, 1.9579916166911961, 6)
