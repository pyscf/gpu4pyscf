...
class SEMParams:
    ...
    def _compute_multipole_angular_factors(self):
        ...
        sq3 = np.sqrt(3.0)
        inv_sq3 = 1.0 / sq3         # ~ 0.5773502691896257
        two_inv_sq3 = 2.0 / sq3     # ~ 1.1547005383792515
        two_thirds = 2.0 / 3.0      # ~ 0.6666666666666666
        four_thirds = 4.0 / 3.0     # ~ 1.3333333333333333

        set_ch(0,0,0, 1.0)
        set_ch(1,1,0, 1.0)
        set_ch(2,1,1, 1.0)
        set_ch(3,1,-1, 1.0)
        set_ch(4,2,0, two_inv_sq3)
        set_ch(5,2,1, 1.0)
        set_ch(6,2,-1, 1.0)
        set_ch(7,2,2, 1.0)
        set_ch(8,2,-2, 1.0)
        set_ch(9,0,0, 1.0)
        set_ch(9,2,0, four_thirds)
        set_ch(10,2,1, 1.0)
        set_ch(11,2,-1, 1.0)
        set_ch(12,1,0, two_inv_sq3)
        set_ch(13,1,1, 1.0)
        set_ch(14,1,-1, 1.0)
        set_ch(17,0,0, 1.0)
        set_ch(17,2,0, -two_thirds)
        set_ch(17,2,2, 1.0)
        set_ch(18,2,-2, 1.0)
        set_ch(19,1,1, -inv_sq3)
        set_ch(20,1,0, 1.0)
        set_ch(22,1,1, 1.0)
        set_ch(23,1,-1, 1.0)
        set_ch(24,0,0, 1.0)
        set_ch(24,2,0, -two_thirds)
        set_ch(24,2,2, -1.0)
        set_ch(25,1,-1, -inv_sq3)
        set_ch(27,1,0, 1.0)
        set_ch(28,1,-1, -1.0)
        set_ch(29,1,1, 1.0)
        set_ch(30,0,0, 1.0)
        set_ch(30,2,0, four_thirds)
        set_ch(31,2,1, inv_sq3)
        set_ch(32,2,-1, inv_sq3)
        set_ch(33,2,2, -two_inv_sq3)
        set_ch(34,2,-2, -two_inv_sq3)
        set_ch(35,0,0, 1.0)
        set_ch(35,2,0, two_thirds)
        set_ch(35,2,2, 1.0)
        set_ch(36,2,-2, 1.0)
        set_ch(37,2,1, 1.0)
        set_ch(38,2,-1, 1.0)
        set_ch(39,0,0, 1.0)
        set_ch(39,2,0, two_thirds)
        set_ch(39,2,2, -1.0)
        set_ch(40,2,-1, -1.0)
        set_ch(41,2,1, 1.0)
        set_ch(42,0,0, 1.0)
        set_ch(42,2,0, -four_thirds)
        set_ch(44,0,0, 1.0)
        set_ch(44,2,0, -four_thirds)
