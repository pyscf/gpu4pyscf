...
#pragma unroll
            ...
            if (task_id < ntasks) {
                ...
                for (int i_dm = 0; i_dm < kmat.n_dm; ++i_dm) {
                    ...
                    val = 0;
                    val += gout[0] * dm_jk[(j0+0)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+0)*nao+(l0+0), val);
                    val = 0;
                    val += gout[0] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+0), val);
                    if (ish_cell0 != jsh_cell0) {
                        ...
                        val = 0;
                        val += gout[0] * dm_ik[(i0+0)*nao+(k0+0)];
                        atomicAdd(vk_jl+(j0+0)*nao+(l0+0), val);
                        val = 0;
                        val += gout[0] * dm_il[(i0+0)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+0), val);
                    }
                }
            }
        }
...
#pragma unroll
            ...
            if (task_id < ntasks) {
                ...
                for (int i_dm = 0; i_dm < kmat.n_dm; ++i_dm) {
                    ...
                    atomicAdd(vk_il+(i0+0)*nao+(l0+0), val);
                    val = 0;
                    val += gout[1] * dm_jk[(j0+0)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+1)*nao+(l0+0), val);
                    val = 0;
                    val += gout[2] * dm_jk[(j0+0)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+2)*nao+(l0+0), val);
                    val = 0;
                    val += gout[0] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+0), val);
                    val = 0;
                    val += gout[1] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+0), val);
                    val = 0;
                    val += gout[2] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+0), val);
                    if (ish_cell0 != jsh_cell0) {
                        double *dm_ik = dm + Ts_ij_lookup[cell_k*nimgs] * nao2;
                        double *dm_il = dm + Ts_ij_lookup[cell_l*nimgs] * nao2;
                        double *vk_jl = vk + Ts_ij_lookup[cell_j*nimgs+cell_l] * nao2;
                        ...
                        val = 0;
                        val += gout[0] * dm_ik[(i0+0)*nao+(k0+0)];
                        val += gout[1] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[2] * dm_ik[(i0+2)*nao+(k0+0)];
                        atomicAdd(vk_jl+(j0+0)*nao+(l0+0), val);
                        val = 0;
                        val += gout[0] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[1] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[2] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+0), val);
                    }
                }
            }
...
#pragma unroll
            ...
            if (task_id < ntasks) {
                ...
                for (int i_dm = 0; i_dm < kmat.n_dm; ++i_dm) {
                    ...
                    val = 0;
                    val += gout[0] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[3] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[6] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+0)*nao+(l0+0), val);
                    val = 0;
                    val += gout[1] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[4] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[7] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+1)*nao+(l0+0), val);
                    val = 0;
                    val += gout[2] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[5] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[8] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+2)*nao+(l0+0), val);
                    val = 0;
                    val += gout[0] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+0), val);
                    val = 0;
                    val += gout[3] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+1), val);
                    val = 0;
                    val += gout[6] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+2), val);
                    val = 0;
                    val += gout[1] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+0), val);
                    val = 0;
                    val += gout[4] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+1), val);
                    val = 0;
                    val += gout[7] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+2), val);
                    val = 0;
                    val += gout[2] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+0), val);
                    val = 0;
                    val += gout[5] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+1), val);
                    val = 0;
                    val += gout[8] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+2), val);
                    if (ish_cell0 != jsh_cell0) {
                        double *dm_ik = dm + Ts_ij_lookup[cell_k*nimgs] * nao2;
                        double *dm_il = dm + Ts_ij_lookup[cell_l*nimgs] * nao2;
                        double *vk_jl = vk + Ts_ij_lookup[cell_j*nimgs+cell_l] * nao2;
                        ...
                        val = 0;
                        val += gout[0] * dm_ik[(i0+0)*nao+(k0+0)];
                        val += gout[3] * dm_ik[(i0+0)*nao+(k0+1)];
                        val += gout[6] * dm_ik[(i0+0)*nao+(k0+2)];
                        val += gout[1] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[4] * dm_ik[(i0+1)*nao+(k0+1)];
                        val += gout[7] * dm_ik[(i0+1)*nao+(k0+2)];
                        val += gout[2] * dm_ik[(i0+2)*nao+(k0+0)];
                        val += gout[5] * dm_ik[(i0+2)*nao+(k0+1)];
                        val += gout[8] * dm_ik[(i0+2)*nao+(k0+2)];
                        atomicAdd(vk_jl+(j0+0)*nao+(l0+0), val);
                        val = 0;
                        val += gout[0] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[1] * dm_il[(i0+1)*nao+(l0+0)];
                        ...
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+0), val);
                        val = 0;
                        val += gout[3] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[4] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[5] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+1), val);
                        val = 0;
                        val += gout[6] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[7] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[8] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+2), val);
                    }
                }
            }
        }
...
#pragma unroll
            ...
            if (task_id < ntasks) {
                ...
                for (int i_dm = 0; i_dm < kmat.n_dm; ++i_dm) {
                    ...
                    atomicAdd(vk_il+(i0+0)*nao+(l0+0), val);
                    val = 0;
                    val += gout[9] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[12] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[15] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+0)*nao+(l0+1), val);
                    val = 0;
                    val += gout[18] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[21] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[24] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+0)*nao+(l0+2), val);
                    val = 0;
                    val += gout[1] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[4] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[7] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+1)*nao+(l0+0), val);
                    val = 0;
                    val += gout[10] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[13] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[16] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+1)*nao+(l0+1), val);
                    val = 0;
                    val += gout[19] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[22] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[25] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+1)*nao+(l0+2), val);
                    val = 0;
                    val += gout[2] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[5] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[8] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+2)*nao+(l0+0), val);
                    val = 0;
                    val += gout[11] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[14] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[17] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+2)*nao+(l0+1), val);
                    val = 0;
                    val += gout[20] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[23] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[26] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+2)*nao+(l0+2), val);
                    val = 0;
                    val += gout[0] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[9] * dm_jl[(j0+0)*nao+(l0+1)];
                    val += gout[18] * dm_jl[(j0+0)*nao+(l0+2)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+0), val);
                    val = 0;
                    val += gout[3] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[12] * dm_jl[(j0+0)*nao+(l0+1)];
                    val += gout[21] * dm_jl[(j0+0)*nao+(l0+2)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+1), val);
                    val = 0;
                    val += gout[6] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[15] * dm_jl[(j0+0)*nao+(l0+1)];
                    val += gout[24] * dm_jl[(j0+0)*nao+(l0+2)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+2), val);
                    val = 0;
                    val += gout[1] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[10] * dm_jl[(j0+0)*nao+(l0+1)];
                    val += gout[19] * dm_jl[(j0+0)*nao+(l0+2)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+0), val);
                    val = 0;
                    val += gout[4] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[13] * dm_jl[(j0+0)*nao+(l0+1)];
                    val += gout[22] * dm_jl[(j0+0)*nao+(l0+2)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+1), val);
                    val = 0;
                    val += gout[7] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[16] * dm_jl[(j0+0)*nao+(l0+1)];
                    val += gout[25] * dm_jl[(j0+0)*nao+(l0+2)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+2), val);
                    val = 0;
                    val += gout[2] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[11] * dm_jl[(j0+0)*nao+(l0+1)];
                    val += gout[20] * dm_jl[(j0+0)*nao+(l0+2)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+0), val);
                    val = 0;
                    val += gout[5] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[14] * dm_jl[(j0+0)*nao+(l0+1)];
                    val += gout[23] * dm_jl[(j0+0)*nao+(l0+2)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+1), val);
                    val = 0;
                    val += gout[8] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[17] * dm_jl[(j0+0)*nao+(l0+1)];
                    val += gout[26] * dm_jl[(j0+0)*nao+(l0+2)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+2), val);
                    if (ish_cell0 != jsh_cell0) {
                        double *dm_ik = dm + Ts_ij_lookup[cell_k*nimgs] * nao2;
                        double *dm_il = dm + Ts_ij_lookup[cell_l*nimgs] * nao2;
                        ...
                        atomicAdd(vk_jl+(j0+0)*nao+(l0+0), val);
                        val = 0;
                        val += gout[9] * dm_ik[(i0+0)*nao+(k0+0)];
                        val += gout[12] * dm_ik[(i0+0)*nao+(k0+1)];
                        val += gout[15] * dm_ik[(i0+0)*nao+(k0+2)];
                        val += gout[10] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[13] * dm_ik[(i0+1)*nao+(k0+1)];
                        val += gout[16] * dm_ik[(i0+1)*nao+(k0+2)];
                        val += gout[11] * dm_ik[(i0+2)*nao+(k0+0)];
                        val += gout[14] * dm_ik[(i0+2)*nao+(k0+1)];
                        val += gout[17] * dm_ik[(i0+2)*nao+(k0+2)];
                        atomicAdd(vk_jl+(j0+0)*nao+(l0+1), val);
                        val = 0;
                        val += gout[18] * dm_ik[(i0+0)*nao+(k0+0)];
                        val += gout[21] * dm_ik[(i0+0)*nao+(k0+1)];
                        val += gout[24] * dm_ik[(i0+0)*nao+(k0+2)];
                        val += gout[19] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[22] * dm_ik[(i0+1)*nao+(k0+1)];
                        val += gout[25] * dm_ik[(i0+1)*nao+(k0+2)];
                        val += gout[20] * dm_ik[(i0+2)*nao+(k0+0)];
                        val += gout[23] * dm_ik[(i0+2)*nao+(k0+1)];
                        val += gout[26] * dm_ik[(i0+2)*nao+(k0+2)];
                        atomicAdd(vk_jl+(j0+0)*nao+(l0+2), val);
                        val = 0;
                        val += gout[0] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[9] * dm_il[(i0+0)*nao+(l0+1)];
                        val += gout[18] * dm_il[(i0+0)*nao+(l0+2)];
                        val += gout[1] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[10] * dm_il[(i0+1)*nao+(l0+1)];
                        val += gout[19] * dm_il[(i0+1)*nao+(l0+2)];
                        val += gout[2] * dm_il[(i0+2)*nao+(l0+0)];
                        val += gout[11] * dm_il[(i0+2)*nao+(l0+1)];
                        val += gout[20] * dm_il[(i0+2)*nao+(l0+2)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+0), val);
                        val = 0;
                        val += gout[3] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[12] * dm_il[(i0+0)*nao+(l0+1)];
                        val += gout[21] * dm_il[(i0+0)*nao+(l0+2)];
                        val += gout[4] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[13] * dm_il[(i0+1)*nao+(l0+1)];
                        val += gout[22] * dm_il[(i0+1)*nao+(l0+2)];
                        val += gout[5] * dm_il[(i0+2)*nao+(l0+0)];
                        val += gout[14] * dm_il[(i0+2)*nao+(l0+1)];
                        val += gout[23] * dm_il[(i0+2)*nao+(l0+2)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+1), val);
                        val = 0;
                        val += gout[6] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[15] * dm_il[(i0+0)*nao+(l0+1)];
                        val += gout[24] * dm_il[(i0+0)*nao+(l0+2)];
                        val += gout[7] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[16] * dm_il[(i0+1)*nao+(l0+1)];
                        val += gout[25] * dm_il[(i0+1)*nao+(l0+2)];
                        val += gout[8] * dm_il[(i0+2)*nao+(l0+0)];
                        val += gout[17] * dm_il[(i0+2)*nao+(l0+1)];
                        val += gout[26] * dm_il[(i0+2)*nao+(l0+2)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+2), val);
                    }
                }
            }
...
#pragma unroll
            ...
            if (task_id < ntasks) {
                ...
                for (int i_dm = 0; i_dm < kmat.n_dm; ++i_dm) {
                    ...
                    val = 0;
                    val += gout[0] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[3] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[6] * dm_jk[(j0+2)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+0)*nao+(l0+0), val);
                    val = 0;
                    val += gout[1] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[4] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[7] * dm_jk[(j0+2)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+1)*nao+(l0+0), val);
                    val = 0;
                    val += gout[2] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[5] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[8] * dm_jk[(j0+2)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+2)*nao+(l0+0), val);
                    val = 0;
                    val += gout[0] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[3] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[6] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+0), val);
                    val = 0;
                    val += gout[1] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[4] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[7] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+0), val);
                    val = 0;
                    val += gout[2] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[5] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[8] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+0), val);
                    if (ish_cell0 != jsh_cell0) {
                        double *dm_ik = dm + Ts_ij_lookup[cell_k*nimgs] * nao2;
                        double *dm_il = dm + Ts_ij_lookup[cell_l*nimgs] * nao2;
                        ...
                        atomicAdd(vk_jl+(j0+0)*nao+(l0+0), val);
                        val = 0;
                        val += gout[3] * dm_ik[(i0+0)*nao+(k0+0)];
                        val += gout[4] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[5] * dm_ik[(i0+2)*nao+(k0+0)];
                        atomicAdd(vk_jl+(j0+1)*nao+(l0+0), val);
                        val = 0;
                        val += gout[6] * dm_ik[(i0+0)*nao+(k0+0)];
                        val += gout[7] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[8] * dm_ik[(i0+2)*nao+(k0+0)];
                        atomicAdd(vk_jl+(j0+2)*nao+(l0+0), val);
                        val = 0;
                        val += gout[0] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[1] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[2] * dm_il[(i0+2)*nao+(l0+0)];
                        ...
                        val += gout[4] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[5] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+1)*nao+(k0+0), val);
                        val = 0;
                        val += gout[6] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[7] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[8] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+2)*nao+(k0+0), val);
                    }
                }
            }
        }
...
#pragma unroll
            ...
            if (task_id < ntasks) {
                ...
                for (int i_dm = 0; i_dm < kmat.n_dm; ++i_dm) {
                    ...
                    val = 0;
                    val += gout[0] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[9] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[18] * dm_jk[(j0+0)*nao+(k0+2)];
                    val += gout[3] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[12] * dm_jk[(j0+1)*nao+(k0+1)];
                    val += gout[21] * dm_jk[(j0+1)*nao+(k0+2)];
                    val += gout[6] * dm_jk[(j0+2)*nao+(k0+0)];
                    val += gout[15] * dm_jk[(j0+2)*nao+(k0+1)];
                    val += gout[24] * dm_jk[(j0+2)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+0)*nao+(l0+0), val);
                    val = 0;
                    val += gout[1] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[10] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[19] * dm_jk[(j0+0)*nao+(k0+2)];
                    val += gout[4] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[13] * dm_jk[(j0+1)*nao+(k0+1)];
                    val += gout[22] * dm_jk[(j0+1)*nao+(k0+2)];
                    val += gout[7] * dm_jk[(j0+2)*nao+(k0+0)];
                    val += gout[16] * dm_jk[(j0+2)*nao+(k0+1)];
                    val += gout[25] * dm_jk[(j0+2)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+1)*nao+(l0+0), val);
                    val = 0;
                    val += gout[2] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[11] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[20] * dm_jk[(j0+0)*nao+(k0+2)];
                    val += gout[5] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[14] * dm_jk[(j0+1)*nao+(k0+1)];
                    val += gout[23] * dm_jk[(j0+1)*nao+(k0+2)];
                    val += gout[8] * dm_jk[(j0+2)*nao+(k0+0)];
                    val += gout[17] * dm_jk[(j0+2)*nao+(k0+1)];
                    val += gout[26] * dm_jk[(j0+2)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+2)*nao+(l0+0), val);
                    val = 0;
                    val += gout[0] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[3] * dm_jl[(j0+1)*nao+(l0+0)];
                    ...
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+0), val);
                    val = 0;
                    val += gout[9] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[12] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[15] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+1), val);
                    val = 0;
                    val += gout[18] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[21] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[24] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+2), val);
                    val = 0;
                    val += gout[1] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[4] * dm_jl[(j0+1)*nao+(l0+0)];
                    ...
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+0), val);
                    val = 0;
                    val += gout[10] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[13] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[16] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+1), val);
                    val = 0;
                    val += gout[19] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[22] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[25] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+2), val);
                    val = 0;
                    val += gout[2] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[5] * dm_jl[(j0+1)*nao+(l0+0)];
                    ...
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+0), val);
                    val = 0;
                    val += gout[11] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[14] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[17] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+1), val);
                    val = 0;
                    val += gout[20] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[23] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[26] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+2), val);
                    if (ish_cell0 != jsh_cell0) {
                        double *dm_ik = dm + Ts_ij_lookup[cell_k*nimgs] * nao2;
                        double *dm_il = dm + Ts_ij_lookup[cell_l*nimgs] * nao2;
                        ...
                        val = 0;
                        val += gout[0] * dm_ik[(i0+0)*nao+(k0+0)];
                        val += gout[9] * dm_ik[(i0+0)*nao+(k0+1)];
                        val += gout[18] * dm_ik[(i0+0)*nao+(k0+2)];
                        val += gout[1] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[10] * dm_ik[(i0+1)*nao+(k0+1)];
                        val += gout[19] * dm_ik[(i0+1)*nao+(k0+2)];
                        val += gout[2] * dm_ik[(i0+2)*nao+(k0+0)];
                        val += gout[11] * dm_ik[(i0+2)*nao+(k0+1)];
                        val += gout[20] * dm_ik[(i0+2)*nao+(k0+2)];
                        atomicAdd(vk_jl+(j0+0)*nao+(l0+0), val);
                        val = 0;
                        val += gout[3] * dm_ik[(i0+0)*nao+(k0+0)];
                        val += gout[12] * dm_ik[(i0+0)*nao+(k0+1)];
                        val += gout[21] * dm_ik[(i0+0)*nao+(k0+2)];
                        val += gout[4] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[13] * dm_ik[(i0+1)*nao+(k0+1)];
                        val += gout[22] * dm_ik[(i0+1)*nao+(k0+2)];
                        val += gout[5] * dm_ik[(i0+2)*nao+(k0+0)];
                        val += gout[14] * dm_ik[(i0+2)*nao+(k0+1)];
                        val += gout[23] * dm_ik[(i0+2)*nao+(k0+2)];
                        atomicAdd(vk_jl+(j0+1)*nao+(l0+0), val);
                        val = 0;
                        val += gout[6] * dm_ik[(i0+0)*nao+(k0+0)];
                        val += gout[15] * dm_ik[(i0+0)*nao+(k0+1)];
                        val += gout[24] * dm_ik[(i0+0)*nao+(k0+2)];
                        val += gout[7] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[16] * dm_ik[(i0+1)*nao+(k0+1)];
                        val += gout[25] * dm_ik[(i0+1)*nao+(k0+2)];
                        val += gout[8] * dm_ik[(i0+2)*nao+(k0+0)];
                        val += gout[17] * dm_ik[(i0+2)*nao+(k0+1)];
                        val += gout[26] * dm_ik[(i0+2)*nao+(k0+2)];
                        atomicAdd(vk_jl+(j0+2)*nao+(l0+0), val);
                        val = 0;
                        val += gout[0] * dm_il[(i0+0)*nao+(l0+0)];
                        ...
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+0), val);
                        val = 0;
                        val += gout[9] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[10] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[11] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+1), val);
                        val = 0;
                        val += gout[18] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[19] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[20] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+2), val);
                        val = 0;
                        val += gout[3] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[4] * dm_il[(i0+1)*nao+(l0+0)];
                        ...
                        atomicAdd(vk_jk+(j0+1)*nao+(k0+0), val);
                        val = 0;
                        val += gout[12] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[13] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[14] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+1)*nao+(k0+1), val);
                        val = 0;
                        val += gout[21] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[22] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[23] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+1)*nao+(k0+2), val);
                        val = 0;
                        val += gout[6] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[7] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[8] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+2)*nao+(k0+0), val);
                        val = 0;
                        val += gout[15] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[16] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[17] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+2)*nao+(k0+1), val);
                        val = 0;
                        val += gout[24] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[25] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[26] * dm_il[(i0+2)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+2)*nao+(k0+2), val);
                    }
                }
            }
        }
...
#pragma unroll
            ...
            if (task_id < ntasks) {
                ...
                for (int i_dm = 0; i_dm < kmat.n_dm; ++i_dm) {
                    ...
                    atomicAdd(vk_il+(i0+2)*nao+(l0+0), val);
                    val = 0;
                    val += gout[3] * dm_jk[(j0+0)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+3)*nao+(l0+0), val);
                    val = 0;
                    val += gout[4] * dm_jk[(j0+0)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+4)*nao+(l0+0), val);
                    val = 0;
                    val += gout[5] * dm_jk[(j0+0)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+5)*nao+(l0+0), val);
                    val = 0;
                    val += gout[0] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+0), val);
                    val = 0;
                    ...
                    val = 0;
                    val += gout[3] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+3)*nao+(k0+0), val);
                    val = 0;
                    val += gout[4] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+4)*nao+(k0+0), val);
                    val = 0;
                    val += gout[5] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+5)*nao+(k0+0), val);
                    if (ish_cell0 != jsh_cell0) {
                        double *dm_ik = dm + Ts_ij_lookup[cell_k*nimgs] * nao2;
                        double *dm_il = dm + Ts_ij_lookup[cell_l*nimgs] * nao2;
                        double *vk_jl = vk + Ts_ij_lookup[cell_j*nimgs+cell_l] * nao2;
                        ...
                        val += gout[1] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[2] * dm_ik[(i0+2)*nao+(k0+0)];
                        val += gout[3] * dm_ik[(i0+3)*nao+(k0+0)];
                        val += gout[4] * dm_ik[(i0+4)*nao+(k0+0)];
                        val += gout[5] * dm_ik[(i0+5)*nao+(k0+0)];
                        atomicAdd(vk_jl+(j0+0)*nao+(l0+0), val);
                        val = 0;
                        val += gout[0] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[1] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[2] * dm_il[(i0+2)*nao+(l0+0)];
                        val += gout[3] * dm_il[(i0+3)*nao+(l0+0)];
                        val += gout[4] * dm_il[(i0+4)*nao+(l0+0)];
                        val += gout[5] * dm_il[(i0+5)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+0), val);
                    }
                }
            }
...
#pragma unroll
            ...
            if (task_id < ntasks) {
                ...
                for (int i_dm = 0; i_dm < kmat.n_dm; ++i_dm) {
                    ...
                    val = 0;
                    val += gout[0] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[6] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[12] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+0)*nao+(l0+0), val);
                    val = 0;
                    val += gout[1] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[7] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[13] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+1)*nao+(l0+0), val);
                    val = 0;
                    val += gout[2] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[8] * dm_jk[(j0+0)*nao+(k0+1)];
                    val += gout[14] * dm_jk[(j0+0)*nao+(k0+2)];
                    atomicAdd(vk_il+(i0+2)*nao+(l0+0), val);
                    val = 0;
                    val += gout[3] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[9] * dm_jk[(j0+0)*nao+(k0+1)];
                    ...
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+1), val);
                    val = 0;
                    val += gout[12] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+2), val);
                    val = 0;
                    val += gout[1] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+0), val);
                    ...
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+1), val);
                    val = 0;
                    val += gout[13] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+2), val);
                    val = 0;
                    val += gout[2] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+0), val);
                    ...
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+1), val);
                    val = 0;
                    val += gout[14] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+2), val);
                    val = 0;
                    val += gout[3] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+3)*nao+(k0+0), val);
                    val = 0;
                    val += gout[9] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+3)*nao+(k0+1), val);
                    val = 0;
                    val += gout[15] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+3)*nao+(k0+2), val);
                    val = 0;
                    val += gout[4] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+4)*nao+(k0+0), val);
                    val = 0;
                    val += gout[10] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+4)*nao+(k0+1), val);
                    val = 0;
                    val += gout[16] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+4)*nao+(k0+2), val);
                    val = 0;
                    val += gout[5] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+5)*nao+(k0+0), val);
                    val = 0;
                    val += gout[11] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+5)*nao+(k0+1), val);
                    val = 0;
                    val += gout[17] * dm_jl[(j0+0)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+5)*nao+(k0+2), val);
                    if (ish_cell0 != jsh_cell0) {
                        double *dm_ik = dm + Ts_ij_lookup[cell_k*nimgs] * nao2;
                        double *dm_il = dm + Ts_ij_lookup[cell_l*nimgs] * nao2;
                        double *vk_jl = vk + Ts_ij_lookup[cell_j*nimgs+cell_l] * nao2;
                        ...
                        val = 0;
                        val += gout[0] * dm_ik[(i0+0)*nao+(k0+0)];
                        val += gout[6] * dm_ik[(i0+0)*nao+(k0+1)];
                        val += gout[12] * dm_ik[(i0+0)*nao+(k0+2)];
                        val += gout[1] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[7] * dm_ik[(i0+1)*nao+(k0+1)];
                        val += gout[13] * dm_ik[(i0+1)*nao+(k0+2)];
                        val += gout[2] * dm_ik[(i0+2)*nao+(k0+0)];
                        val += gout[8] * dm_ik[(i0+2)*nao+(k0+1)];
                        val += gout[14] * dm_ik[(i0+2)*nao+(k0+2)];
                        val += gout[3] * dm_ik[(i0+3)*nao+(k0+0)];
                        val += gout[9] * dm_ik[(i0+3)*nao+(k0+1)];
                        val += gout[15] * dm_ik[(i0+3)*nao+(k0+2)];
                        val += gout[4] * dm_ik[(i0+4)*nao+(k0+0)];
                        val += gout[10] * dm_ik[(i0+4)*nao+(k0+1)];
                        val += gout[16] * dm_ik[(i0+4)*nao+(k0+2)];
                        val += gout[5] * dm_ik[(i0+5)*nao+(k0+0)];
                        val += gout[11] * dm_ik[(i0+5)*nao+(k0+1)];
                        val += gout[17] * dm_ik[(i0+5)*nao+(k0+2)];
                        atomicAdd(vk_jl+(j0+0)*nao+(l0+0), val);
                        val = 0;
                        val += gout[0] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[1] * dm_il[(i0+1)*nao+(l0+0)];
                        ...
                        val += gout[7] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[8] * dm_il[(i0+2)*nao+(l0+0)];
                        val += gout[9] * dm_il[(i0+3)*nao+(l0+0)];
                        val += gout[10] * dm_il[(i0+4)*nao+(l0+0)];
                        val += gout[11] * dm_il[(i0+5)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+1), val);
                        val = 0;
                        val += gout[12] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[13] * dm_il[(i0+1)*nao+(l0+0)];
                        val += gout[14] * dm_il[(i0+2)*nao+(l0+0)];
                        val += gout[15] * dm_il[(i0+3)*nao+(l0+0)];
                        val += gout[16] * dm_il[(i0+4)*nao+(l0+0)];
                        val += gout[17] * dm_il[(i0+5)*nao+(l0+0)];
                        atomicAdd(vk_jk+(j0+0)*nao+(k0+2), val);
                    }
                }
            }
...
#pragma unroll
            ...
            if (task_id < ntasks) {
                ...
                for (int i_dm = 0; i_dm < kmat.n_dm; ++i_dm) {
                    ...
                    val = 0;
                    val += gout[0] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[6] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[12] * dm_jk[(j0+2)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+0)*nao+(l0+0), val);
                    val = 0;
                    val += gout[1] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[7] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[13] * dm_jk[(j0+2)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+1)*nao+(l0+0), val);
                    val = 0;
                    val += gout[2] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[8] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[14] * dm_jk[(j0+2)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+2)*nao+(l0+0), val);
                    val = 0;
                    val += gout[3] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[9] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[15] * dm_jk[(j0+2)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+3)*nao+(l0+0), val);
                    val = 0;
                    val += gout[4] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[10] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[16] * dm_jk[(j0+2)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+4)*nao+(l0+0), val);
                    val = 0;
                    val += gout[5] * dm_jk[(j0+0)*nao+(k0+0)];
                    val += gout[11] * dm_jk[(j0+1)*nao+(k0+0)];
                    val += gout[17] * dm_jk[(j0+2)*nao+(k0+0)];
                    atomicAdd(vk_il+(i0+5)*nao+(l0+0), val);
                    val = 0;
                    val += gout[0] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[6] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[12] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+0)*nao+(k0+0), val);
                    val = 0;
                    val += gout[1] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[7] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[13] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+1)*nao+(k0+0), val);
                    val = 0;
                    val += gout[2] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[8] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[14] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+2)*nao+(k0+0), val);
                    val = 0;
                    val += gout[3] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[9] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[15] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+3)*nao+(k0+0), val);
                    val = 0;
                    val += gout[4] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[10] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[16] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+4)*nao+(k0+0), val);
                    val = 0;
                    val += gout[5] * dm_jl[(j0+0)*nao+(l0+0)];
                    val += gout[11] * dm_jl[(j0+1)*nao+(l0+0)];
                    val += gout[17] * dm_jl[(j0+2)*nao+(l0+0)];
                    atomicAdd(vk_ik+(i0+5)*nao+(k0+0), val);
                    if (ish_cell0 != jsh_cell0) {
                        double *dm_ik = dm + Ts_ij_lookup[cell_k*nimgs] * nao2;
                        ...
                        val += gout[7] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[8] * dm_ik[(i0+2)*nao+(k0+0)];
                        val += gout[9] * dm_ik[(i0+3)*nao+(k0+0)];
                        val += gout[10] * dm_ik[(i0+4)*nao+(k0+0)];
                        val += gout[11] * dm_ik[(i0+5)*nao+(k0+0)];
                        atomicAdd(vk_jl+(j0+1)*nao+(l0+0), val);
                        val = 0;
                        val += gout[12] * dm_ik[(i0+0)*nao+(k0+0)];
                        val += gout[13] * dm_ik[(i0+1)*nao+(k0+0)];
                        val += gout[14] * dm_ik[(i0+2)*nao+(k0+0)];
                        val += gout[15] * dm_ik[(i0+3)*nao+(k0+0)];
                        val += gout[16] * dm_ik[(i0+4)*nao+(k0+0)];
                        val += gout[17] * dm_ik[(i0+5)*nao+(k0+0)];
                        atomicAdd(vk_jl+(j0+2)*nao+(l0+0), val);
                        val = 0;
                        val += gout[0] * dm_il[(i0+0)*nao+(l0+0)];
                        val += gout[1] * dm_il[(i0+1)*nao+(l0+0)];
