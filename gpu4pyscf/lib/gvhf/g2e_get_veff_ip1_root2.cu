  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    ...
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        double gx1 = C00x*gx0;
        double gx3 = D00x*gx0;
        double gx4 = B00*gx0+D00x*gx1;
        double gx2 = ABx*gx0+gx1;
        double gx5 = ABx*gx3+gx4;
        double gy1 = C00y*gy0;
        double gy3 = D00y*gy0;
        double gy4 = B00*gy0+D00y*gy1;
        double gy2 = ABy*gy0+gy1;
        double gy5 = ABy*gy3+gy4;
        double gz1 = C00z*gz0;
        double gz3 = D00z*gz0;
        double gz4 = B00*gz0+D00z*gz1;
        double gz2 = ABz*gz0+gz1;
        double gz5 = ABz*gz3+gz4;
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    ...
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        double gx3 = D00x*gx0;
        double gx4 = B00*gx0+D00x*gx1;
        double gx6 = B01*gx0+D00x*gx3;
        double gx7 = B01*gx1+B00*gx3+D00x*gx4;
        double gx2 = ABx*gx0+gx1;
        double gx5 = ABx*gx3+gx4;
        double gx8 = ABx*gx6+gx7;
        double gx6 = CDx*gx0+gx3;
        double gx7 = CDx*gx1+gx4;
        double gx8 = CDx*gx2+gx5;
        double gy1 = C00y*gy0;
        double gy3 = D00y*gy0;
        double gy4 = B00*gy0+D00y*gy1;
        double gy6 = B01*gy0+D00y*gy3;
        double gy7 = B01*gy1+B00*gy3+D00y*gy4;
        double gy2 = ABy*gy0+gy1;
        double gy5 = ABy*gy3+gy4;
        double gy8 = ABy*gy6+gy7;
        double gy6 = CDy*gy0+gy3;
        double gy7 = CDy*gy1+gy4;
        double gy8 = CDy*gy2+gy5;
        double gz1 = C00z*gz0;
        double gz3 = D00z*gz0;
        double gz4 = B00*gz0+D00z*gz1;
        double gz6 = B01*gz0+D00z*gz3;
        double gz7 = B01*gz1+B00*gz3+D00z*gz4;
        double gz2 = ABz*gz0+gz1;
        double gz5 = ABz*gz3+gz4;
        double gz8 = ABz*gz6+gz7;
        double gz6 = CDz*gz0+gz3;
        double gz7 = CDz*gz1+gz4;
        double gz8 = CDz*gz2+gz5;
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    ...
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        double gy0 = 1;
        double gx1 = C00x*gx0;
        double gx2 = B10*gx0+C00x*gx1;
        double gx4 = ABx*gx1+gx2;
        double gx3 = ABx*gx0+gx1;
        double gy1 = C00y*gy0;
        double gy2 = B10*gy0+C00y*gy1;
        double gy4 = ABy*gy1+gy2;
        double gy3 = ABy*gy0+gy1;
        double gz1 = C00z*gz0;
        double gz2 = B10*gz0+C00z*gz1;
        double gz4 = ABz*gz1+gz2;
        double gz3 = ABz*gz0+gz1;
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    ...
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        double gx2 = B10*gx0+C00x*gx1;
        double gx5 = D00x*gx0;
        double gx6 = B00*gx0+D00x*gx1;
        double gx7 = 2*B00*gx1+D00x*gx2;
        double gx4 = ABx*gx1+gx2;
        double gx3 = ABx*gx0+gx1;
        double gx9 = ABx*gx6+gx7;
        double gx8 = ABx*gx5+gx6;
        double gy1 = C00y*gy0;
        double gy2 = B10*gy0+C00y*gy1;
        double gy5 = D00y*gy0;
        double gy6 = B00*gy0+D00y*gy1;
        double gy7 = 2*B00*gy1+D00y*gy2;
        double gy4 = ABy*gy1+gy2;
        double gy3 = ABy*gy0+gy1;
        double gy9 = ABy*gy6+gy7;
        double gy8 = ABy*gy5+gy6;
        double gz1 = C00z*gz0;
        double gz2 = B10*gz0+C00z*gz1;
        double gz5 = D00z*gz0;
        double gz6 = B00*gz0+D00z*gz1;
        double gz7 = 2*B00*gz1+D00z*gz2;
        double gz4 = ABz*gz1+gz2;
        double gz3 = ABz*gz0+gz1;
        double gz9 = ABz*gz6+gz7;
        double gz8 = ABz*gz5+gz6;
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    ...
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        double gx1 = C00x*gx0;
        double gx2 = B10*gx0+C00x*gx1;
        double gx3 = 2*B10*gx1+C00x*gx2;
        double gx5 = ABx*gx2+gx3;
        double gx4 = ABx*gx1+gx2;
        double gx3 = ABx*gx0+gx1;
        double gx7 = ABx*gx4+gx5;
        double gx6 = ABx*gx3+gx4;
        double gy1 = C00y*gy0;
        double gy2 = B10*gy0+C00y*gy1;
        double gy3 = 2*B10*gy1+C00y*gy2;
        double gy5 = ABy*gy2+gy3;
        double gy4 = ABy*gy1+gy2;
        double gy3 = ABy*gy0+gy1;
        double gy7 = ABy*gy4+gy5;
        double gy6 = ABy*gy3+gy4;
        double gz1 = C00z*gz0;
        double gz2 = B10*gz0+C00z*gz1;
        double gz3 = 2*B10*gz1+C00z*gz2;
        double gz5 = ABz*gz2+gz3;
        double gz4 = ABz*gz1+gz2;
        double gz3 = ABz*gz0+gz1;
        double gz7 = ABz*gz4+gz5;
        double gz6 = ABz*gz3+gz4;
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    ...
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        double gx2 = B10*gx0+C00x*gx1;
        double gx3 = 2*B10*gx1+C00x*gx2;
        double gx6 = ABx*gx2+gx3;
        double gx5 = ABx*gx1+gx2;
        double gx4 = ABx*gx0+gx1;
        double gy1 = C00y*gy0;
        double gy2 = B10*gy0+C00y*gy1;
        double gy3 = 2*B10*gy1+C00y*gy2;
        double gy6 = ABy*gy2+gy3;
        double gy5 = ABy*gy1+gy2;
        double gy4 = ABy*gy0+gy1;
        double gz1 = C00z*gz0;
        double gz2 = B10*gz0+C00z*gz1;
        double gz3 = 2*B10*gz1+C00z*gz2;
        double gz6 = ABz*gz2+gz3;
        double gz5 = ABz*gz1+gz2;
        double gz4 = ABz*gz0+gz1;
