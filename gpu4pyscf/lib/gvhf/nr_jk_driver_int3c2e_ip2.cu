...
static int GINTrun_tasks_int3c2e_ip2_jk(JKMatrix *jk, BasisProdOffsets *offsets, GINTEnvVars *envs, cudaStream_t stream)
{
    ...
    switch (type_ijk) {
        ...
        case  33: GINTint3c2e_ip2_jk_kernel<0,3,3><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        ...
        case 123: GINTint3c2e_ip2_jk_kernel<1,2,3><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        ...
        case 132: GINTint3c2e_ip2_jk_kernel<1,3,2><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 133: GINTint3c2e_ip2_jk_kernel<1,3,3><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        ...
        case 213: GINTint3c2e_ip2_jk_kernel<2,1,3><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        ...
        case 222: GINTint3c2e_ip2_jk_kernel<2,2,2><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 223: GINTint3c2e_ip2_jk_kernel<2,2,3><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 230: GINTint3c2e_ip2_jk_kernel<2,3,0><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 231: GINTint3c2e_ip2_jk_kernel<2,3,1><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 232: GINTint3c2e_ip2_jk_kernel<2,3,2><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 233: GINTint3c2e_ip2_jk_kernel<2,3,3><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        ...
        case 303: GINTint3c2e_ip2_jk_kernel<3,0,3><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        ...
        case 312: GINTint3c2e_ip2_jk_kernel<3,1,2><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 313: GINTint3c2e_ip2_jk_kernel<3,1,3><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 320: GINTint3c2e_ip2_jk_kernel<3,2,0><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 321: GINTint3c2e_ip2_jk_kernel<3,2,1><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 322: GINTint3c2e_ip2_jk_kernel<3,2,2><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 323: GINTint3c2e_ip2_jk_kernel<3,2,3><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 330: GINTint3c2e_ip2_jk_kernel<3,3,0><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 331: GINTint3c2e_ip2_jk_kernel<3,3,1><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 332: GINTint3c2e_ip2_jk_kernel<3,3,2><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
        case 333: GINTint3c2e_ip2_jk_kernel<3,3,3><<<blocks, threads, 0, stream>>>(*envs, *jk, *offsets); break;
