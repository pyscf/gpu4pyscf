...
__host__
static int GINTrun_tasks_int3c2e_ip2_jk(JKMatrix *jk, BasisProdOffsets *offsets, GINTEnvVars *envs)
{
    ...
    switch (envs->nrys_roots) {
        case 1: GINTrun_int3c2e_ip2_jk_kernel0010<<<blocks, threads>>>(*envs, *jk, *offsets); break;
        case 2: GINTint3c2e_ip2_jk_kernel<2, GSIZE2_INT3C> <<<blocks, threads>>>(*envs, *jk, *offsets); break;
        case 3: GINTint3c2e_ip2_jk_kernel<3, GSIZE3_INT3C> <<<blocks, threads>>>(*envs, *jk, *offsets); break;
        case 4: GINTint3c2e_ip2_jk_kernel<4, GSIZE4_INT3C> <<<blocks, threads>>>(*envs, *jk, *offsets); break;
        case 5: GINTint3c2e_ip2_jk_kernel<5, GSIZE5_INT3C> <<<blocks, threads>>>(*envs, *jk, *offsets); break;
        case 6: GINTint3c2e_ip2_jk_kernel<6, GSIZE6_INT3C> <<<blocks, threads>>>(*envs, *jk, *offsets); break;
        case 7: GINTint3c2e_ip2_jk_kernel<7, GSIZE7_INT3C> <<<blocks, threads>>>(*envs, *jk, *offsets); break;
        case 8: GINTint3c2e_ip2_jk_kernel<8, GSIZE8_INT3C> <<<blocks, threads>>>(*envs, *jk, *offsets); break;
        default:
                 ...
                 int cp_ij_id, int cp_kl_id, int ip_type, double omega)
{
    ...
    for (kl_bin = 0; kl_bin < nbins; kl_bin++) {
        ...
        int err = GINTrun_tasks_int3c2e_ip2_jk(&jk, &offsets, &envs);
