...
__global__ static
void eval_mgga_strain_kernel(double *out, double *dm,
...
extern "C" {
#define eval_mgga_strain_kernel_case(li, lj, slice_i, slice_j) \
    case (li * LMAX1 + lj): \
        eval_mgga_strain_kernel<li,lj,slice_i,slice_j><<<npairs, threads>>>( \
            out, dm, vxc, tau, *envs, bas_ij_idx, grid_frac_ranges, \
            da_squared, db_squared, dc_squared, mesh_a, mesh_b, mesh_c, npairs, \
            factor, negligible); \
    break

int evaluate_mgga_strain(double *out, double *dm,
                         ...
                         double factor, double negligible)
{
    ...
    dim3 threads(16, 16);
    switch (li * LMAX1 + lj) {
        eval_mgga_strain_kernel_case(0,0, 1, 1);
        eval_mgga_strain_kernel_case(1,0, 3, 1);
        eval_mgga_strain_kernel_case(1,1, 3, 3);
        eval_mgga_strain_kernel_case(2,0, 6, 1);
        eval_mgga_strain_kernel_case(2,1, 6, 3);
        eval_mgga_strain_kernel_case(2,2, 6, 6);
        eval_mgga_strain_kernel_case(3,0,10, 1);
        eval_mgga_strain_kernel_case(3,1, 5, 3);
        eval_mgga_strain_kernel_case(3,2, 5, 6);
        eval_mgga_strain_kernel_case(3,3, 5, 5);
        eval_mgga_strain_kernel_case(4,0,15, 1);
        eval_mgga_strain_kernel_case(4,1, 8, 3);
        eval_mgga_strain_kernel_case(4,2, 5, 6);
        eval_mgga_strain_kernel_case(4,3, 5, 5);
        eval_mgga_strain_kernel_case(4,4, 5, 5);
    }
