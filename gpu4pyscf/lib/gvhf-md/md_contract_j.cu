                 ...
                 int threadsx, int threadsy, int tilex, int tiley)
{
    ...
    double *vj_kl_cache = dm_kl_cache + nf3kl * threadsy;
...
#pragma unroll
            for (int n = 0, i = gout_id; n < IJ_SIZE; ++n, i += gout_stride) {
                ...
                for (int k = 0; k < nf3kl; ++k) {
                    ...
                    vj_ij[n] += efg_phase[k] * s * dm_kl_cache[ty+k*threadsy];
                }
            }
            __syncthreads();
...
//__global__
//void md_j_in_register_1dm(RysIntEnvVars envs, JKMatrix jk, MDBoundsInfo bounds,
//                          int threadsx, int threadsy, int tilex, int tiley)
//{
//}
//
//__global__
//void md_j_in_shm_1dm(RysIntEnvVars envs, JKMatrix jk, MDBoundsInfo bounds,
//                          int threadsx, int threadsy, int tilex, int tiley)
//{
//}
//
//__global__
//void md_j_in_register_4dm(RysIntEnvVars envs, JKMatrix jk, MDBoundsInfo bounds,
//                 int threadsx, int threadsy, int tilex, int tiley)
//{
//}
//
//__global__
//void md_j_in_shm_4dm(RysIntEnvVars envs, JKMatrix jk, MDBoundsInfo bounds,
//                 int threadsx, int threadsy, int tilex, int tiley)
//{
//}
