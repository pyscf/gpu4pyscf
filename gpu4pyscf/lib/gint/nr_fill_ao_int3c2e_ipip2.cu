...
static int GINTfill_int3c2e_ipip2(ERITensor *eri, BasisProdOffsets *offsets, GINTEnvVars *envs, cudaStream_t stream)
{
    ...
    switch (type_ijk) {
        case   0: GINTfill_int3c2e_ipip2_kernel<0,0,0><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        ...
        case  33: GINTfill_int3c2e_ipip2_kernel<0,3,3><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        ...
        case 123: GINTfill_int3c2e_ipip2_kernel<1,2,3><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        ...
        case 132: GINTfill_int3c2e_ipip2_kernel<1,3,2><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 133: GINTfill_int3c2e_ipip2_kernel<1,3,3><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        ...
        case 213: GINTfill_int3c2e_ipip2_kernel<2,1,3><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        ...
        case 222: GINTfill_int3c2e_ipip2_kernel<2,2,2><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 223: GINTfill_int3c2e_ipip2_kernel<2,2,3><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 230: GINTfill_int3c2e_ipip2_kernel<2,3,0><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 231: GINTfill_int3c2e_ipip2_kernel<2,3,1><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 232: GINTfill_int3c2e_ipip2_kernel<2,3,2><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 233: GINTfill_int3c2e_ipip2_kernel<2,3,3><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        ...
        case 303: GINTfill_int3c2e_ipip2_kernel<3,0,3><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        ...
        case 312: GINTfill_int3c2e_ipip2_kernel<3,1,2><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 313: GINTfill_int3c2e_ipip2_kernel<3,1,3><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 320: GINTfill_int3c2e_ipip2_kernel<3,2,0><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 321: GINTfill_int3c2e_ipip2_kernel<3,2,1><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 322: GINTfill_int3c2e_ipip2_kernel<3,2,2><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 323: GINTfill_int3c2e_ipip2_kernel<3,2,3><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 330: GINTfill_int3c2e_ipip2_kernel<3,3,0><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 331: GINTfill_int3c2e_ipip2_kernel<3,3,1><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 332: GINTfill_int3c2e_ipip2_kernel<3,3,2><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
        case 333: GINTfill_int3c2e_ipip2_kernel<3,3,3><<<blocks, threads, 0, stream>>>(*envs, *eri, *offsets); break;
