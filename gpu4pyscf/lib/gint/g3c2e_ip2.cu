...
static void GINTfill_int3c2e_ip2_kernel(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
...
template <> __global__
void GINTfill_int3c2e_ip2_kernel<2,GSIZE2_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
...
template <> __global__
void GINTfill_int3c2e_ip2_kernel<3,GSIZE3_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
...
template <> __global__
void GINTfill_int3c2e_ip2_kernel<4,GSIZE4_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
...
template <> __global__
void GINTfill_int3c2e_ip2_kernel<5,GSIZE5_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
...
template <> __global__
void GINTfill_int3c2e_ip2_kernel<6,GSIZE6_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
...
template <> __global__
void GINTfill_int3c2e_ip2_kernel<7,GSIZE7_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
...
template <> __global__
void GINTfill_int3c2e_ip2_kernel<8,GSIZE8_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
...
template <> __global__
void GINTfill_int3c2e_ip2_kernel<9,GSIZE9_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
