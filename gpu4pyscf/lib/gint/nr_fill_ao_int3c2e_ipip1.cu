...
__host__
static int GINTfill_int3c2e_ipip1_tasks(ERITensor *eri, BasisProdOffsets *offsets, GINTEnvVars *envs)
{
    ...
    switch (envs->nrys_roots) {
        case 2: GINTfill_int3c2e_ipip1_kernel<2, GSIZE2_INT3C> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case 3: GINTfill_int3c2e_ipip1_kernel<3, GSIZE3_INT3C> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case 4: GINTfill_int3c2e_ipip1_kernel<4, GSIZE4_INT3C> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case 5: GINTfill_int3c2e_ipip1_kernel<5, GSIZE5_INT3C> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case 6: GINTfill_int3c2e_ipip1_kernel<6, GSIZE6_INT3C> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case 7: GINTfill_int3c2e_ipip1_kernel<7, GSIZE7_INT3C> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case 8: GINTfill_int3c2e_ipip1_kernel<8, GSIZE8_INT3C> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
        default:
...
extern "C" {
int GINTfill_int3c2e_ipip1(BasisProdCache *bpcache, double *eri, int nao,
                   ...
                   int cp_ij_id, int cp_kl_id, double omega)
{
    ...
    for (kl_bin = 0; kl_bin < nbins; kl_bin++) {
        ...
        int err = GINTfill_int3c2e_ipip1_tasks(&eritensor, &offsets, &envs);
