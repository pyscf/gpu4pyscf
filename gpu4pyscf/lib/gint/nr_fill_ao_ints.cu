...
static int GINTfill_int2e_tasks(ERITensor *eri, BasisProdOffsets *offsets, GINTEnvVars *envs)
{
    ...
    case 1:
        ...
        switch (type_ijkl) {
        case 0b0000: GINTfill_int2e_kernel0000<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case 0b0010: GINTfill_int2e_kernel0010<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case 0b1000: GINTfill_int2e_kernel1000<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        default:
            //GINTfill_int2e_kernel<1, GOUTSIZE1> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
    ...
    case 2:
        ...
        switch (type_ijkl) {
        case (0<<6)|(0<<4)|(1<<2)|1: GINTfill_int2e_kernel0011<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (0<<6)|(0<<4)|(2<<2)|0: GINTfill_int2e_kernel0020<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (0<<6)|(0<<4)|(2<<2)|1: GINTfill_int2e_kernel0021<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        ...
        case (1<<6)|(0<<4)|(1<<2)|1: GINTfill_int2e_kernel1011<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        ...
        default:
            GINTfill_int2e_kernel<2, GOUTSIZE2> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
        }
        break;
    case 3:
        type_ijkl = (envs->i_l << 6) | (envs->j_l << 4) | (envs->k_l << 2) | envs->l_l;
        switch (type_ijkl) {
        case (0<<6)|(0<<4)|(2<<2)|2: GINTfill_int2e_kernel0022<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (0<<6)|(0<<4)|(3<<2)|1: GINTfill_int2e_kernel0031<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (0<<6)|(0<<4)|(3<<2)|2: GINTfill_int2e_kernel0032<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (1<<6)|(0<<4)|(2<<2)|1: GINTfill_int2e_kernel1021<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (1<<6)|(0<<4)|(2<<2)|2: GINTfill_int2e_kernel1022<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (1<<6)|(0<<4)|(3<<2)|0: GINTfill_int2e_kernel1030<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (1<<6)|(0<<4)|(3<<2)|1: GINTfill_int2e_kernel1031<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (1<<6)|(1<<4)|(1<<2)|1: GINTfill_int2e_kernel1111<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (1<<6)|(1<<4)|(2<<2)|0: GINTfill_int2e_kernel1120<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (1<<6)|(1<<4)|(2<<2)|1: GINTfill_int2e_kernel1121<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (1<<6)|(1<<4)|(3<<2)|0: GINTfill_int2e_kernel1130<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (2<<6)|(0<<4)|(1<<2)|1: GINTfill_int2e_kernel2011<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (2<<6)|(0<<4)|(2<<2)|0: GINTfill_int2e_kernel2020<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        case (2<<6)|(0<<4)|(2<<2)|1: GINTfill_int2e_kernel2021<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        ...
        case (2<<6)|(1<<4)|(1<<2)|1: GINTfill_int2e_kernel2111<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        ...
        case (3<<6)|(0<<4)|(1<<2)|1: GINTfill_int2e_kernel3011<<<blocks, threads>>>(*envs, *eri, *offsets); break;
        ...
        default:
            GINTfill_int2e_kernel<3, GOUTSIZE3> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
        }
        break;
    case 4: GINTfill_int2e_kernel<4, GOUTSIZE4> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
    case 5: GINTfill_int2e_kernel<5, GOUTSIZE5> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
    case 6: GINTfill_int2e_kernel<6, GOUTSIZE6> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
    case 7: GINTfill_int2e_kernel<7, GOUTSIZE7> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
    case 8: GINTfill_int2e_kernel<8, GOUTSIZE8> <<<blocks, threads>>>(*envs, *eri, *offsets); break;
    default:
