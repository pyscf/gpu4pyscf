...
static void GINTfill_int3c2e_ipip1_kernel(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
...
template <> __global__
void GINTfill_int3c2e_ipip1_kernel<2,GSIZE2_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    ...
    for (ij = prim_ij; ij < prim_ij+nprim_ij; ++ij) {
        for (kl = prim_kl; kl < prim_kl+nprim_kl; ++kl) {
            ...
            GINTnabla1i_2e<2>(envs, g1, g0, ai2, envs.i_l+1, envs.j_l, envs.k_l);
...
template <> __global__
void GINTfill_int3c2e_ipip1_kernel<3,GSIZE3_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (ij = prim_ij; ij < prim_ij+nprim_ij; ++ij) {
        for (kl = prim_kl; kl < prim_kl+nprim_kl; ++kl) {
            ...
            double ai2 = -2.0*exp_bra[ij];
            GINTnabla1i_2e<3>(envs, g1, g0, ai2, envs.i_l+1, envs.j_l, envs.k_l);
...
template <> __global__
void GINTfill_int3c2e_ipip1_kernel<4,GSIZE4_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (ij = prim_ij; ij < prim_ij+nprim_ij; ++ij) {
        for (kl = prim_kl; kl < prim_kl+nprim_kl; ++kl) {
            ...
            double ai2 = -2.0*exp_bra[ij];
            GINTnabla1i_2e<4>(envs, g1, g0, ai2, envs.i_l+1, envs.j_l, envs.k_l);
...
template <> __global__
void GINTfill_int3c2e_ipip1_kernel<5,GSIZE5_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (ij = prim_ij; ij < prim_ij+nprim_ij; ++ij) {
        for (kl = prim_kl; kl < prim_kl+nprim_kl; ++kl) {
            ...
            double ai2 = -2.0*exp_bra[ij];
            GINTnabla1i_2e<5>(envs, g1, g0, ai2, envs.i_l+1, envs.j_l, envs.k_l);
...
template <> __global__
void GINTfill_int3c2e_ipip1_kernel<6,GSIZE6_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (ij = prim_ij; ij < prim_ij+nprim_ij; ++ij) {
        for (kl = prim_kl; kl < prim_kl+nprim_kl; ++kl) {
            ...
            double ai2 = -2.0*exp_bra[ij];
            GINTnabla1i_2e<6>(envs, g1, g0, ai2, envs.i_l+1, envs.j_l, envs.k_l);
...
template <> __global__
void GINTfill_int3c2e_ipip1_kernel<7,GSIZE7_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (ij = prim_ij; ij < prim_ij+nprim_ij; ++ij) {
        for (kl = prim_kl; kl < prim_kl+nprim_kl; ++kl) {
            ...
            double ai2 = -2.0*exp_bra[ij];
            GINTnabla1i_2e<7>(envs, g1, g0, ai2, envs.i_l+1, envs.j_l, envs.k_l);
...
template <> __global__
void GINTfill_int3c2e_ipip1_kernel<8,GSIZE8_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (ij = prim_ij; ij < prim_ij+nprim_ij; ++ij) {
        for (kl = prim_kl; kl < prim_kl+nprim_kl; ++kl) {
            ...
            double ai2 = -2.0*exp_bra[ij];
            GINTnabla1i_2e<8>(envs, g1, g0, ai2, envs.i_l+1, envs.j_l, envs.k_l);
...
template <> __global__
void GINTfill_int3c2e_ipip1_kernel<9,GSIZE9_INT3C>(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (ij = prim_ij; ij < prim_ij+nprim_ij; ++ij) {
        for (kl = prim_kl; kl < prim_kl+nprim_kl; ++kl) {
            ...
            double ai2 = -2.0*exp_bra[ij];
            GINTnabla1i_2e<9>(envs, g1, g0, ai2, envs.i_l+1, envs.j_l, envs.k_l);
