...
cutlass::Status grouped_gemm_kernel_run(int problem_count, cutlass::gemm::GemmCoord* problem_host_sizes, cutlass::gemm::GemmCoord* problem_sizes,
...
void grouped_gemm_kernel_launch(uint64_t *out, uint64_t *x, uint64_t *y, int64_t *Ms, int64_t *Ns, int64_t *Ks, int num)
{
  ...
  cutlass::Status status = grouped_gemm_kernel_run<DeviceKernel>(
      num,
      reinterpret_cast<cutlass::gemm::GemmCoord*>(host_data),
...
int grouped_dot_host(cudaStream_t stream, uint64_t *out, uint64_t *x, uint64_t *y, int64_t *Ms, int64_t *Ns, int64_t *Ks, int num)
{
