...
static void _cart2sph_ang5(double *cart, double *sph, int stride, int count){
    ...
    sph[sph_offset+0*stride] = 3.2819102842008507 * g1 + -6.5638205684017006 * g6 + 0.6563820568401701 * g15;
    sph[sph_offset+1*stride] = 8.3026492595241645 * (g4 - g11);
    sph[sph_offset+2*stride] = -1.4677148983057511 * g1 + -0.9784765988705008 * g6 + 11.7417191864460086 * g8 + 0.4892382994352504 * g15 + -3.9139063954820030 * g17;
    sph[sph_offset+3*stride] = -4.7935367849733241 * (g4 + g11) + 9.5870735699466483 * g13;
    sph[sph_offset+4*stride] = 0.4529466511956969 * (g1 + g15) + 0.9058933023913939 * g6 + -5.4353598143483630 * (g8 + g17) + 3.6235732095655755 * g19;
    sph[sph_offset+5*stride] = 1.7542548368013540 * (g2 + g16) + 3.5085096736027079 * g7 + -4.6780128981369442 * (g9 + g18) + 0.9356025796273888 * g20;
    sph[sph_offset+6*stride] = 0.4529466511956969 * (g0 + g10) + 0.9058933023913939 * g3 + -5.4353598143483630 * (g5 + g12) + 3.6235732095655755 * g14;
    sph[sph_offset+7*stride] = -2.3967683924866621 * (g2 - g16) + 4.7935367849733241 * (g9 - g18);
    sph[sph_offset+8*stride] = -0.4892382994352504 * g0 + 0.9784765988705008 * g3 + 3.9139063954820030 * g5 + 1.4677148983057511 * g10 + -11.7417191864460086 * g12;
    sph[sph_offset+9*stride] = 2.0756623148810411 * (g2 + g16) + -12.4539738892862477 * g7;
    sph[sph_offset+10*stride] = 0.6563820568401701 * g0 + -6.5638205684017006 * g3 + 3.2819102842008507 * g10;
}
...
static void _cart2sph_ang6(double *cart, double *sph, int stride, int count){
    ...
    sph[sph_offset+4*stride] = 0.9212052595149236 * (g1 + g15) + 1.8424105190298472 * g6 + -14.7392841522387776 * (g8 + g17 - g19);
    ...
    sph[sph_offset+6*stride] = -0.3178460113381421 * (g0 + g21) + -0.9535380340144264 * (g3 + g10) + 5.7212282040865583 * (g5 + g23) + 11.4424564081731166 * g12 + -7.6283042721154111 * (g14 + g25) + 1.0171072362820548 * g27;
    ...
    sph[sph_offset+9*stride] = -2.7636157785447706 * g2 + 5.5272315570895412 * g7 + 7.3696420761193888 * g9 + 8.2908473356343109 * g16 + -22.1089262283581647 * g18;
    ...
    sph[sph_offset+11*stride] = 2.3666191622317525 * g2 + -23.6661916223175268 * g7 + 11.8330958111587634 * g16;
