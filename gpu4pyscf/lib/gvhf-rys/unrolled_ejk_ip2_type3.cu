...
void rys_ejk_ip2_type3_1011(KERNEL_ARGS)
{
    ...
    uint32_t *bas_kl_idx = pool + blockIdx_x * QUEUE_DEPTH;
    double *dd_cache = dd_pool + blockIdx_x * 1728 + sq_id;
while (1) {
    __syncthreads();
    if (t_id == 0) {
        int task_id = atomicAdd(head, 1);
                        ...
                        uint32_t *pool, double *dd_pool, int *head, int workers)
{
    ...
    switch (ijkl) {
    case 0: // (0, 0, 0, 0)
        adjust_threads(rys_ejk_ip2_type3_0000, nsq_per_block);
        break;
    case 125: // (1, 0, 0, 0)
        adjust_threads(rys_ejk_ip2_type3_1000, nsq_per_block);
        break;
    case 130: // (1, 0, 1, 0)
        adjust_threads(rys_ejk_ip2_type3_1010, nsq_per_block);
        break;
    case 131: // (1, 0, 1, 1)
        nsq_per_block = 64;
        gout_stride = 4;
        break;
    case 150: // (1, 1, 0, 0)
        adjust_threads(rys_ejk_ip2_type3_1100, nsq_per_block);
        break;
    case 155: // (1, 1, 1, 0)
        nsq_per_block = 64;
        gout_stride = 4;
    ...
    switch (ijkl) {
    case 0: LAUNCH_KERNEL(rys_ejk_ip2_type3_0000); break;
    case 125: LAUNCH_KERNEL(rys_ejk_ip2_type3_1000); break;
    case 130: LAUNCH_KERNEL(rys_ejk_ip2_type3_1010); break;
    case 131: buflen = 4608 + iprim*jprim; LAUNCH_KERNEL(rys_ejk_ip2_type3_1011); break;
    case 150: LAUNCH_KERNEL(rys_ejk_ip2_type3_1100); break;
    case 155: buflen = 4608 + iprim*jprim; LAUNCH_KERNEL(rys_ejk_ip2_type3_1110); break;
    case 156: buflen = 4160 + iprim*jprim; LAUNCH_KERNEL(rys_ejk_ip2_type3_1111); break;
    default: return 0;
    }
    return 1;
}
