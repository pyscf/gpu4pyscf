...
__global__ static
void rys_k_0000(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
...
__global__ static
void rys_k_1000(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_1010(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_1011(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_1100(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_1110(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_1111(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_2000(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_2010(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_2011(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_2020(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_2021(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
...
__global__ static
void rys_k_2100(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_2110(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_2111(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int gout_id = threadIdx.y;
...
__global__ static
void rys_k_2120(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int gout_id = threadIdx.y;
    int t_id = 64 * gout_id + sq_id;
...
__global__ static
void rys_k_2200(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_2210(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int gout_id = threadIdx.y;
    int t_id = 64 * gout_id + sq_id;
...
__global__ static
void rys_k_3000(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_3010(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_3011(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int gout_id = threadIdx.y;
    int t_id = 64 * gout_id + sq_id;
...
__global__ static
void rys_k_3020(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_3100(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
...
__global__ static
void rys_k_3110(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int gout_id = threadIdx.y;
    int t_id = 64 * gout_id + sq_id;
...
__global__ static
void rys_k_3200(RysIntEnvVars envs, JKMatrix kmat, BoundsInfo bounds, uint32_t *pool, int *head)
{
    int sq_id = threadIdx.x;
    int nsq_per_block = blockDim.x;
