...
extern __global__ void rys_j_kernel_experiment(RysIntEnvVars envs, JKMatrix jk, BoundsInfo bounds,
...
int RYS_init_rysj_constant(int shm_size)
{
    ...
    cudaFuncSetAttribute(rys_j_kernel_experiment, cudaFuncAttributeMaxDynamicSharedMemorySize, shm_size);
