                        ...
                        uint32_t *pool, double *dd_pool, int *head, int workers)
{
    ...
    switch (ijkl) {
    case 0: // (0, 0, 0, 0)
        LAUNCH_KERNEL(rys_ejk_ip2_type12_0000); break;
    case 125: // (1, 0, 0, 0)
        LAUNCH_KERNEL(rys_ejk_ip2_type12_1000); break;
    case 130: // (1, 0, 1, 0)
        LAUNCH_KERNEL(rys_ejk_ip2_type12_1010); break;
    case 131: // (1, 0, 1, 1)
        buflen = 5760 + iprim * jprim;
        LAUNCH_KERNEL(rys_ejk_ip2_type12_1011); break;
    case 150: // (1, 1, 0, 0)
        LAUNCH_KERNEL(rys_ejk_ip2_type12_1100); break;
    case 155: // (1, 1, 1, 0)
        buflen = 5760 + iprim * jprim;
        LAUNCH_KERNEL(rys_ejk_ip2_type12_1110); break;
    case 156: // (1, 1, 1, 1)
        buflen = 4240 + iprim * jprim;
        LAUNCH_KERNEL(rys_ejk_ip2_type12_1111); break;
    default: return 0;
    }
    return 1;
}
