                ...
                for (int irys = 0; irys < nroots; ++irys) {
                    ...
                    if (pair_ij < shl_pair1 && kidx < ksh1) {
                        ...
                        case 0:
                            ...
                            v_jy += (aj2 * (gx[1344] - yjyi * Iy) - 1 * gx[1024]) * prod_xz;
                            v_jz += aj2 * (gx[2176] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                            ...
                            v_jy += aj2 * (gx[1088] - yjyi * Iy) * prod_xz;
                            v_jz += (aj2 * (gx[2368] - zjzi * Iz) - 1 * gx[2048]) * prod_xy;
                            if (density_auxvec == NULL) {
                            ...
                            v_jy += aj2 * (gx[1152] - yjyi * Iy) * prod_xz;
                            v_jz += (aj2 * (gx[2432] - zjzi * Iz) - 1 * gx[2112]) * prod_xy;
                            break;
                        case 1:
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[1*naux + 0*nksh];
                            ...
                            v_kz += ak2 * gx[2560] * prod_xy;
                            v_jx += aj2 * (gx[64] - xjxi * Ix) * prod_yz;
                            v_jy += (aj2 * (gx[1472] - yjyi * Iy) - 1 * gx[1152]) * prod_xz;
                            v_jz += aj2 * (gx[2112] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                            ...
                            v_jx += aj2 * (gx[64] - xjxi * Ix) * prod_yz;
                            v_jy += aj2 * (gx[1088] - yjyi * Iy) * prod_xz;
                            v_jz += (aj2 * (gx[2496] - zjzi * Iz) - 1 * gx[2176]) * prod_xy;
                            break;
                        case 2:
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[2*naux + 0*nksh];
                            ...
                            v_kz += ak2 * gx[2624] * prod_xy;
                            v_jx += aj2 * (gx[64] - xjxi * Ix) * prod_yz;
                            v_jy += (aj2 * (gx[1408] - yjyi * Iy) - 1 * gx[1088]) * prod_xz;
                            v_jz += aj2 * (gx[2176] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                    ...
                    int aux_offset, int naux, int nao)
{
    ...
    double *Rpq = shared_memory + st_id;
    double *gx = shared_memory + 192 + st_id;
    double *rw = shared_memory + 2496 + st_id;
    double *rjri = shared_memory + 2496 + nroots * 128 + sp_id;
    if (gout_id == 0) {
        gx[0] = 1.;
    }
    for (int pair_ij = shl_pair0+sp_id; pair_ij < shl_pair1+sp_id; pair_ij += nsp_per_block) {
                ...
                for (int irys = 0; irys < nroots; ++irys) {
                    ...
                    if (pair_ij < shl_pair1 && kidx < ksh1) {
                        ...
                        case 0:
                            ...
                            prod_yz = Iy * Iz * dm_ijk;
                            v_ix += (ai2 * gx[448] - 2 * gx[320]) * prod_yz;
                            v_iy += ai2 * gx[832] * prod_xz;
                            v_iz += ai2 * gx[1600] * prod_xy;
                            ...
                            prod_yz = Iy * Iz * dm_ijk;
                            v_ix += ai2 * gx[320] * prod_yz;
                            v_iy += (ai2 * gx[896] - 1 * gx[768]) * prod_xz;
                            v_iz += (ai2 * gx[1664] - 1 * gx[1536]) * prod_xy;
                            v_kx += (ak2 * gx[512] - 1 * gx[0]) * prod_yz;
                            v_ky += ak2 * gx[1088] * prod_xz;
                            v_kz += ak2 * gx[1856] * prod_xy;
                            v_jx += aj2 * (gx[320] - xjxi * Ix) * prod_yz;
                            v_jy += aj2 * (gx[896] - yjyi * Iy) * prod_xz;
                            v_jz += aj2 * (gx[1664] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[2*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[0*nao+2] * density_auxvec[k0+1];
                            ...
                            v_ix += ai2 * gx[64] * prod_yz;
                            v_iy += (ai2 * gx[896] - 1 * gx[768]) * prod_xz;
                            v_iz += (ai2 * gx[1920] - 1 * gx[1792]) * prod_xy;
                            v_kx += ak2 * gx[256] * prod_yz;
                            v_ky += ak2 * gx[1088] * prod_xz;
                            v_kz += (ak2 * gx[2112] - 1 * gx[1600]) * prod_xy;
                            v_jx += aj2 * (gx[64] - xjxi * Ix) * prod_yz;
                            v_jy += aj2 * (gx[896] - yjyi * Iy) * prod_xz;
                            v_jz += aj2 * (gx[1920] - zjzi * Iz) * prod_xy;
                            break;
                        case 1:
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[1*naux + 0*nksh];
                            ...
                            v_ix += ai2 * gx[320] * prod_yz;
                            v_iy += ai2 * gx[832] * prod_xz;
                            v_iz += (ai2 * gx[1728] - 2 * gx[1600]) * prod_xy;
                            v_kx += (ak2 * gx[512] - 1 * gx[0]) * prod_yz;
                            v_ky += ak2 * gx[1024] * prod_xz;
                            ...
                            v_ix += ai2 * gx[64] * prod_yz;
                            v_iy += ai2 * gx[832] * prod_xz;
                            v_iz += (ai2 * gx[1984] - 2 * gx[1856]) * prod_xy;
                            v_kx += ak2 * gx[256] * prod_yz;
                            v_ky += ak2 * gx[1024] * prod_xz;
                        ...
                        case 3:
                            ...
                            prod_yz = Iy * Iz * dm_ijk;
                            v_ix += ai2 * gx[320] * prod_yz;
                            v_iy += (ai2 * gx[960] - 2 * gx[832]) * prod_xz;
                            v_iz += ai2 * gx[1600] * prod_xy;
                            v_kx += (ak2 * gx[512] - 1 * gx[0]) * prod_yz;
...
__device__ inline
void int3c2e_ip1_221(double *ejk, double *ejk_aux, double *dm, double *density_auxvec,
                    RysIntEnvVars& envs, int shl_pair0, int shl_pair1,
                    int ksh0, int ksh1, int iprim, int jprim, int kprim,
                    double omega, uint32_t *bas_ij_idx, int *ao_pair_loc,
                    int aux_offset, int naux, int nao)
{
    ...
    __syncthreads();
    constexpr int aux_per_block = 16;
    constexpr int nsp_per_block = 2;
    constexpr int nst_per_block = 32;
    int gout_id = thread_id / 32;
    int st_id = thread_id % 32;
    int sp_id = st_id / aux_per_block;
    int aux_id = st_id - sp_id * aux_per_block;
    extern __shared__ double shared_memory[];
    double *Rpq = shared_memory + st_id;
    double *gx = shared_memory + 96 + st_id;
    double *rw = shared_memory + 3552 + st_id;
    double *rjri = shared_memory + 3552 + nroots * 64 + sp_id;
    if (gout_id == 0) {
        gx[0] = 1.;
    }
    for (int pair_ij = shl_pair0+sp_id; pair_ij < shl_pair1+sp_id; pair_ij += nsp_per_block) {
        ...
        for (int kidx = ksh0+aux_id; kidx < ksh1+aux_id; kidx += aux_per_block) {
            ...
            for (int ijkp = 0; ijkp < ijkprim; ++ijkp) {
                ...
                double rr = xpq * xpq + ypq * ypq + zpq * zpq;
                double theta = aij * ak / (aij + ak);
                rys_roots_rs(nroots, theta, rr, omega, rw, nst_per_block, gout_id, 8);
                for (int irys = 0; irys < nroots; ++irys) {
                    __syncthreads();
                    double xjxi = rjri[0*nsp_per_block];
                    double yjyi = rjri[1*nsp_per_block];
                    ...
                    if (pair_ij < shl_pair1 && kidx < ksh1) {
                        ...
                        case 0:
                            ...
                            v_jz += (aj2 * (gx[2464] - zjzi * Iz) - 1 * gx[2304]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[20*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+2] * density_auxvec[k0+1];
                            }
                            Ix = gx[32];
                            Iy = gx[1792];
                            Iz = gx[2336];
                            ...
                            v_jz += aj2 * (gx[2368] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[28*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+4] * density_auxvec[k0+1];
                            }
                            Ix = gx[0];
                            Iy = gx[1696];
                            Iz = gx[2464];
                            ...
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[24*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+0] * density_auxvec[k0+2];
                            }
                            Ix = gx[64];
                            Iy = gx[1280];
                            Iz = gx[2816];
                            ...
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[32*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+2] * density_auxvec[k0+2];
                            }
                            Ix = gx[32];
                            Iy = gx[1152];
                            Iz = gx[2976];
                        ...
                        case 1:
                            ...
                            v_jz += (aj2 * (gx[2464] - zjzi * Iz) - 1 * gx[2304]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[21*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+3] * density_auxvec[k0+1];
                            }
                            Ix = gx[0];
                            Iy = gx[1856];
                            Iz = gx[2304];
                            ...
                            v_jz += aj2 * (gx[2336] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[29*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+5] * density_auxvec[k0+1];
                            }
                            Ix = gx[0];
                            Iy = gx[1664];
                            Iz = gx[2496];
                            ...
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[25*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+1] * density_auxvec[k0+2];
                            }
                            Ix = gx[32];
                            Iy = gx[1312];
                            Iz = gx[2816];
                            ...
                            v_jz += (aj2 * (gx[2848] - zjzi * Iz) - 1 * gx[2688]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[33*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+3] * density_auxvec[k0+2];
                            }
                            Ix = gx[0];
                            Iy = gx[1216];
                            Iz = gx[2944];
                        ...
                        case 2:
                            ...
                            v_jz += (aj2 * (gx[2496] - zjzi * Iz) - 1 * gx[2336]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[22*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+4] * density_auxvec[k0+1];
                            }
                            Ix = gx[0];
                            Iy = gx[1824];
                            Iz = gx[2336];
                            ...
                            v_jz += aj2 * (gx[2368] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[30*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+0] * density_auxvec[k0+1];
                            }
                            Ix = gx[64];
                            Iy = gx[1536];
                            Iz = gx[2560];
                            ...
                            v_jz += aj2 * (gx[2752] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[18*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+0] * density_auxvec[k0+2];
                            }
                            Ix = gx[64];
                            Iy = gx[1408];
                            Iz = gx[2688];
                            ...
                            v_jz += aj2 * (gx[2720] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[26*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+2] * density_auxvec[k0+2];
                            }
                            Ix = gx[32];
                            Iy = gx[1280];
                            Iz = gx[2848];
                            ...
                            v_jz += (aj2 * (gx[2880] - zjzi * Iz) - 1 * gx[2720]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[34*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+4] * density_auxvec[k0+2];
                            }
                            Ix = gx[0];
                            Iy = gx[1184];
                            Iz = gx[2976];
                        ...
                        case 3:
                            ...
                            v_jz += (aj2 * (gx[2464] - zjzi * Iz) - 1 * gx[2304]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[23*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+5] * density_auxvec[k0+1];
                            }
                            Ix = gx[0];
                            Iy = gx[1792];
                            Iz = gx[2368];
                            ...
                            v_jz += aj2 * (gx[2400] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[31*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+1] * density_auxvec[k0+1];
                            }
                            Ix = gx[32];
                            Iy = gx[1568];
                            Iz = gx[2560];
                            ...
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[19*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+1] * density_auxvec[k0+2];
                            }
                            Ix = gx[32];
                            Iy = gx[1440];
                            Iz = gx[2688];
                            ...
                            v_jz += aj2 * (gx[2720] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[27*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+3] * density_auxvec[k0+2];
                            }
                            Ix = gx[0];
                            Iy = gx[1344];
                            Iz = gx[2816];
                            ...
                            v_jz += (aj2 * (gx[2848] - zjzi * Iz) - 1 * gx[2688]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[35*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+5] * density_auxvec[k0+2];
                            }
                            Ix = gx[0];
                            Iy = gx[1152];
                            Iz = gx[3008];
                        ...
                        case 4:
                            ...
                            v_jz += (aj2 * (gx[2496] - zjzi * Iz) - 1 * gx[2336]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[24*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+0] * density_auxvec[k0+1];
                            }
                            Ix = gx[64];
                            Iy = gx[1664];
                            Iz = gx[2432];
                            ...
                            v_jz += (aj2 * (gx[2464] - zjzi * Iz) - 1 * gx[2304]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[32*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+2] * density_auxvec[k0+1];
                            }
                            Ix = gx[32];
                            Iy = gx[1536];
                            Iz = gx[2592];
                            ...
                            v_jz += (aj2 * (gx[2848] - zjzi * Iz) - 1 * gx[2688]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[20*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+2] * density_auxvec[k0+2];
                            }
                            Ix = gx[32];
                            Iy = gx[1408];
                            Iz = gx[2720];
                            ...
                            v_jz += aj2 * (gx[2752] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[28*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+4] * density_auxvec[k0+2];
                            }
                            Ix = gx[0];
                            Iy = gx[1312];
                            Iz = gx[2848];
                        ...
                        case 5:
                            ...
                            v_jz += (aj2 * (gx[2528] - zjzi * Iz) - 1 * gx[2368]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[25*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+1] * density_auxvec[k0+1];
                            }
                            Ix = gx[32];
                            Iy = gx[1696];
                            Iz = gx[2432];
                            ...
                            v_jz += (aj2 * (gx[2464] - zjzi * Iz) - 1 * gx[2304]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[33*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+3] * density_auxvec[k0+1];
                            }
                            Ix = gx[0];
                            Iy = gx[1600];
                            Iz = gx[2560];
                            ...
                            v_jz += (aj2 * (gx[2848] - zjzi * Iz) - 1 * gx[2688]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[21*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+3] * density_auxvec[k0+2];
                            }
                            Ix = gx[0];
                            Iy = gx[1472];
                            Iz = gx[2688];
                            ...
                            v_jz += aj2 * (gx[2720] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[29*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+5] * density_auxvec[k0+2];
                            }
                            Ix = gx[0];
                            Iy = gx[1280];
                            Iz = gx[2880];
                        ...
                        case 6:
                            ...
                            v_jz += aj2 * (gx[2368] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[18*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+0] * density_auxvec[k0+1];
                            }
                            Ix = gx[64];
                            Iy = gx[1792];
                            Iz = gx[2304];
                            ...
                            v_jz += aj2 * (gx[2336] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[26*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+2] * density_auxvec[k0+1];
                            }
                            Ix = gx[32];
                            Iy = gx[1664];
                            Iz = gx[2464];
                            ...
                            v_jz += (aj2 * (gx[2496] - zjzi * Iz) - 1 * gx[2336]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[34*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+4] * density_auxvec[k0+1];
                            }
                            Ix = gx[0];
                            Iy = gx[1568];
                            Iz = gx[2592];
                            ...
                            v_jz += (aj2 * (gx[2880] - zjzi * Iz) - 1 * gx[2720]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[22*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+4] * density_auxvec[k0+2];
                            }
                            Ix = gx[0];
                            Iy = gx[1440];
                            Iz = gx[2720];
                            ...
                            v_jz += aj2 * (gx[2752] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[30*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+0] * density_auxvec[k0+2];
                            }
                            Ix = gx[64];
                            Iy = gx[1152];
                            Iz = gx[2944];
                        ...
                        case 7:
                            ...
                            v_jz += aj2 * (gx[2400] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[19*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+1] * density_auxvec[k0+1];
                            }
                            Ix = gx[32];
                            Iy = gx[1824];
                            Iz = gx[2304];
                            ...
                            v_jz += aj2 * (gx[2336] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[27*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[4*nao+3] * density_auxvec[k0+1];
                            }
                            Ix = gx[0];
                            Iy = gx[1728];
                            Iz = gx[2432];
                            ...
                            v_jz += (aj2 * (gx[2464] - zjzi * Iz) - 1 * gx[2304]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[35*naux + 1*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+5] * density_auxvec[k0+1];
                            }
                            Ix = gx[0];
                            Iy = gx[1536];
                            Iz = gx[2624];
                            ...
                            v_jz += (aj2 * (gx[2848] - zjzi * Iz) - 1 * gx[2688]) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[23*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[3*nao+5] * density_auxvec[k0+2];
                            }
                            Ix = gx[0];
                            Iy = gx[1408];
                            Iz = gx[2752];
                            ...
                            v_jz += aj2 * (gx[2784] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[31*naux + 2*nksh];
                            } else {
                                dm_ijk = dm_tensor[5*nao+1] * density_auxvec[k0+2];
                            }
                            Ix = gx[32];
                            Iy = gx[1184];
                            Iz = gx[2944];
                ...
                for (int irys = 0; irys < nroots; ++irys) {
                    ...
                    if (pair_ij < shl_pair1 && kidx < ksh1) {
                        ...
                        case 0:
                            ...
                            v_iy += ai2 * gx[832] * prod_xz;
                            v_iz += ai2 * gx[1600] * prod_xy;
                            v_kx += (ak2 * gx[640] - 2 * gx[256]) * prod_yz;
                            ...
                            prod_yz = Iy * Iz * dm_ijk;
                            v_ix += ai2 * gx[256] * prod_yz;
                            v_iy += (ai2 * gx[1088] - 1 * gx[960]) * prod_xz;
                            v_iz += ai2 * gx[1600] * prod_xy;
                            v_kx += (ak2 * gx[384] - 1 * gx[0]) * prod_yz;
                            v_ky += (ak2 * gx[1216] - 1 * gx[832]) * prod_xz;
                            v_kz += ak2 * gx[1728] * prod_xy;
                            ...
                            v_ix += ai2 * gx[256] * prod_yz;
                            v_iy += ai2 * gx[832] * prod_xz;
                            v_iz += (ai2 * gx[1856] - 1 * gx[1728]) * prod_xy;
                            v_kx += (ak2 * gx[384] - 1 * gx[0]) * prod_yz;
                            v_ky += ak2 * gx[960] * prod_xz;
                            v_kz += (ak2 * gx[1984] - 1 * gx[1600]) * prod_xy;
                            v_jx += aj2 * (gx[256] - xjxi * Ix) * prod_yz;
                            v_jy += aj2 * (gx[832] - yjyi * Iy) * prod_xz;
                            v_jz += aj2 * (gx[1856] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                            ...
                            prod_yz = Iy * Iz * dm_ijk;
                            v_ix += (ai2 * gx[128] - 1 * gx[0]) * prod_yz;
                            v_iy += ai2 * gx[1024] * prod_xz;
                            v_iz += ai2 * gx[1792] * prod_xy;
                            v_kx += ak2 * gx[256] * prod_yz;
                            v_ky += (ak2 * gx[1152] - 1 * gx[768]) * prod_xz;
                            v_kz += (ak2 * gx[1920] - 1 * gx[1536]) * prod_xy;
                            v_jx += aj2 * (gx[128] - xjxi * Ix) * prod_yz;
                            v_jy += aj2 * (gx[1024] - yjyi * Iy) * prod_xz;
                            v_jz += aj2 * (gx[1792] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                            ...
                            v_ix += ai2 * gx[64] * prod_yz;
                            v_iy += (ai2 * gx[896] - 1 * gx[768]) * prod_xz;
                            v_iz += ai2 * gx[1984] * prod_xy;
                            v_kx += ak2 * gx[192] * prod_yz;
                            v_ky += ak2 * gx[1024] * prod_xz;
                            v_kz += (ak2 * gx[2112] - 2 * gx[1728]) * prod_xy;
                            v_jx += aj2 * (gx[64] - xjxi * Ix) * prod_yz;
                            v_jy += aj2 * (gx[896] - yjyi * Iy) * prod_xz;
                            v_jz += aj2 * (gx[1984] - zjzi * Iz) * prod_xy;
                            break;
                        case 1:
                            ...
                            v_iy += (ai2 * gx[896] - 1 * gx[768]) * prod_xz;
                            v_iz += ai2 * gx[1600] * prod_xy;
                            v_kx += (ak2 * gx[576] - 2 * gx[192]) * prod_yz;
                            v_ky += ak2 * gx[1024] * prod_xz;
                            v_kz += ak2 * gx[1728] * prod_xy;
                            v_jx += aj2 * (gx[448] - xjxi * Ix) * prod_yz;
                            v_jy += aj2 * (gx[896] - yjyi * Iy) * prod_xz;
                            ...
                            v_iz += ai2 * gx[1600] * prod_xy;
                            v_kx += ak2 * gx[256] * prod_yz;
                            v_ky += (ak2 * gx[1344] - 2 * gx[960]) * prod_xz;
                            v_kz += ak2 * gx[1728] * prod_xy;
                            v_jx += aj2 * (gx[128] - xjxi * Ix) * prod_yz;
                            v_jy += aj2 * (gx[1216] - yjyi * Iy) * prod_xz;
                            v_jz += aj2 * (gx[1600] - zjzi * Iz) * prod_xy;
                            ...
                            v_ix += ai2 * gx[64] * prod_yz;
                            v_iy += ai2 * gx[832] * prod_xz;
                            v_iz += (ai2 * gx[2048] - 1 * gx[1920]) * prod_xy;
                            v_kx += ak2 * gx[192] * prod_yz;
                            v_ky += ak2 * gx[960] * prod_xz;
                            v_kz += (ak2 * gx[2176] - 2 * gx[1792]) * prod_xy;
                            v_jx += aj2 * (gx[64] - xjxi * Ix) * prod_yz;
                            v_jy += aj2 * (gx[832] - yjyi * Iy) * prod_xz;
                            v_jz += aj2 * (gx[2048] - zjzi * Iz) * prod_xy;
                            break;
                        case 2:
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[2*naux + 0*nksh];
                            ...
                            v_iy += ai2 * gx[832] * prod_xz;
                            v_iz += ai2 * gx[1792] * prod_xy;
                            v_kx += (ak2 * gx[448] - 1 * gx[64]) * prod_yz;
                            v_ky += ak2 * gx[960] * prod_xz;
                            v_kz += (ak2 * gx[1920] - 1 * gx[1536]) * prod_xy;
                            v_jx += aj2 * (gx[320] - xjxi * Ix) * prod_yz;
                            v_jy += aj2 * (gx[832] - yjyi * Iy) * prod_xz;
                            ...
                            v_iz += ai2 * gx[1600] * prod_xy;
                            v_kx += ak2 * gx[192] * prod_yz;
                            v_ky += (ak2 * gx[1408] - 2 * gx[1024]) * prod_xz;
                            v_kz += ak2 * gx[1728] * prod_xy;
                            v_jx += aj2 * (gx[64] - xjxi * Ix) * prod_yz;
                            v_jy += aj2 * (gx[1280] - yjyi * Iy) * prod_xz;
                            v_jz += aj2 * (gx[1600] - zjzi * Iz) * prod_xy;
...
__device__ inline
void int3c2e_ip1_212(double *ejk, double *ejk_aux, double *dm, double *density_auxvec,
                    RysIntEnvVars& envs, int shl_pair0, int shl_pair1,
                    int ksh0, int ksh1, int iprim, int jprim, int kprim,
                    double omega, uint32_t *bas_ij_idx, int *ao_pair_loc,
                    int aux_offset, int naux, int nao)
{
    ...
    double *Rpq = shared_memory + st_id;
    double *gx = shared_memory + 96 + st_id;
    double *rw = shared_memory + 3168 + st_id;
    double *rjri = shared_memory + 3168 + nroots * 64 + sp_id;
    if (gout_id == 0) {
        gx[0] = 1.;
    }
    for (int pair_ij = shl_pair0+sp_id; pair_ij < shl_pair1+sp_id; pair_ij += nsp_per_block) {
                ...
                for (int irys = 0; irys < nroots; ++irys) {
                    ...
                    if (pair_ij < shl_pair1 && kidx < ksh1) {
                        ...
                        case 0:
                            ...
                            v_jz += aj2 * (gx[2112] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[10*naux + 3*nksh];
                            } else {
                                dm_ijk = dm_tensor[1*nao+4] * density_auxvec[k0+3];
                            }
                            Ix = gx[0];
                            Iy = gx[1696];
                            Iz = gx[2080];
                            ...
                            v_jz += aj2 * (gx[2368] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[16*naux + 4*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+4] * density_auxvec[k0+4];
                            }
                            Ix = gx[0];
                            Iy = gx[1312];
                            Iz = gx[2464];
                            ...
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[14*naux + 5*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+2] * density_auxvec[k0+5];
                            }
                            Ix = gx[32];
                        ...
                        case 1:
                            ...
                            v_jz += aj2 * (gx[2080] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[11*naux + 3*nksh];
                            } else {
                                dm_ijk = dm_tensor[1*nao+5] * density_auxvec[k0+3];
                            }
                            Ix = gx[0];
                            Iy = gx[1664];
                            Iz = gx[2112];
                            ...
                            v_jz += aj2 * (gx[2336] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[9*naux + 4*nksh];
                            } else {
                                dm_ijk = dm_tensor[1*nao+3] * density_auxvec[k0+4];
                            }
                            Ix = gx[0];
                            Iy = gx[1472];
                            Iz = gx[2304];
                            ...
                            v_jz += aj2 * (gx[2336] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[17*naux + 4*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+5] * density_auxvec[k0+4];
                            }
                            Ix = gx[0];
                            Iy = gx[1280];
                            Iz = gx[2496];
                            ...
                            v_jz += aj2 * (gx[2592] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[15*naux + 5*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+3] * density_auxvec[k0+5];
                            }
                            Ix = gx[0];
                            Iy = gx[1088];
                            Iz = gx[2688];
                        ...
                        case 2:
                            ...
                            v_jz += aj2 * (gx[2112] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[12*naux + 3*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+0] * density_auxvec[k0+3];
                            }
                            Ix = gx[64];
                            ...
                            v_jz += aj2 * (gx[2368] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[10*naux + 4*nksh];
                            } else {
                                dm_ijk = dm_tensor[1*nao+4] * density_auxvec[k0+4];
                            }
                            Ix = gx[0];
                            Iy = gx[1440];
                            Iz = gx[2336];
                            ...
                            v_jz += aj2 * (gx[2624] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[16*naux + 5*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+4] * density_auxvec[k0+5];
                            }
                            Ix = gx[0];
                            Iy = gx[1056];
                            Iz = gx[2720];
                        ...
                        case 3:
                            ...
                            v_jz += aj2 * (gx[2144] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[13*naux + 3*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+1] * density_auxvec[k0+3];
                            }
                            Ix = gx[32];
                            ...
                            v_jz += aj2 * (gx[2336] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[11*naux + 4*nksh];
                            } else {
                                dm_ijk = dm_tensor[1*nao+5] * density_auxvec[k0+4];
                            }
                            Ix = gx[0];
                            Iy = gx[1408];
                            Iz = gx[2368];
                            ...
                            v_jz += aj2 * (gx[2592] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[9*naux + 5*nksh];
                            } else {
                                dm_ijk = dm_tensor[1*nao+3] * density_auxvec[k0+5];
                            }
                            Ix = gx[0];
                            Iy = gx[1216];
                            Iz = gx[2560];
                            ...
                            v_jz += aj2 * (gx[2592] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[17*naux + 5*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+5] * density_auxvec[k0+5];
                            }
                            Ix = gx[0];
                            Iy = gx[1024];
                            Iz = gx[2752];
                        ...
                        case 4:
                            ...
                            v_jz += aj2 * (gx[2080] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[14*naux + 3*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+2] * density_auxvec[k0+3];
                            }
                            Ix = gx[32];
                            ...
                            v_jz += aj2 * (gx[2368] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[12*naux + 4*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+0] * density_auxvec[k0+4];
                            }
                            Ix = gx[64];
                            ...
                            v_jz += aj2 * (gx[2624] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[10*naux + 5*nksh];
                            } else {
                                dm_ijk = dm_tensor[1*nao+4] * density_auxvec[k0+5];
                            }
                            Ix = gx[0];
                            Iy = gx[1184];
                            Iz = gx[2592];
                        ...
                        case 5:
                            ...
                            v_jz += aj2 * (gx[2080] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[15*naux + 3*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+3] * density_auxvec[k0+3];
                            }
                            Ix = gx[0];
                            Iy = gx[1600];
                            Iz = gx[2176];
                            ...
                            v_jz += aj2 * (gx[2400] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[13*naux + 4*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+1] * density_auxvec[k0+4];
                            }
                            Ix = gx[32];
                            ...
                            v_jz += aj2 * (gx[2592] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[11*naux + 5*nksh];
                            } else {
                                dm_ijk = dm_tensor[1*nao+5] * density_auxvec[k0+5];
                            }
                            Ix = gx[0];
                            Iy = gx[1152];
                            Iz = gx[2624];
                        ...
                        case 6:
                            ...
                            v_jz += aj2 * (gx[2112] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[16*naux + 3*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+4] * density_auxvec[k0+3];
                            }
                            Ix = gx[0];
                            Iy = gx[1568];
                            Iz = gx[2208];
                            ...
                            v_jz += aj2 * (gx[2336] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[14*naux + 4*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+2] * density_auxvec[k0+4];
                            }
                            Ix = gx[32];
                            ...
                            v_jz += aj2 * (gx[2624] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[12*naux + 5*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+0] * density_auxvec[k0+5];
                            }
                            Ix = gx[64];
                        ...
                        case 7:
                            ...
                            v_jz += aj2 * (gx[2080] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[9*naux + 3*nksh];
                            } else {
                                dm_ijk = dm_tensor[1*nao+3] * density_auxvec[k0+3];
                            }
                            Ix = gx[0];
                            Iy = gx[1728];
                            Iz = gx[2048];
                            ...
                            v_jz += aj2 * (gx[2080] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[17*naux + 3*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+5] * density_auxvec[k0+3];
                            }
                            Ix = gx[0];
                            Iy = gx[1536];
                            Iz = gx[2240];
                            ...
                            v_jz += aj2 * (gx[2336] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[15*naux + 4*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+3] * density_auxvec[k0+4];
                            }
                            Ix = gx[0];
                            Iy = gx[1344];
                            Iz = gx[2432];
                            ...
                            v_jz += aj2 * (gx[2656] - zjzi * Iz) * prod_xy;
                            if (density_auxvec == NULL) {
                                dm_ijk = dm_tensor[13*naux + 5*nksh];
                            } else {
                                dm_ijk = dm_tensor[2*nao+1] * density_auxvec[k0+5];
                            }
                            Ix = gx[32];
                    ...
                    int aux_offset, int naux, int nao)
{
    ...
    case 37: // li=2 lj=2 lk=1
        int3c2e_ip1_221(ejk, ejk_aux, dm, density_auxvec, envs, shl_pair0, shl_pair1, ksh0, ksh1, iprim, jprim, kprim,
            omega, bas_ij_idx, ao_pair_loc, aux_offset, naux, nao); break;
    ...
    case 61: // li=2 lj=1 lk=2
        int3c2e_ip1_212(ejk, ejk_aux, dm, density_auxvec, envs, shl_pair0, shl_pair1, ksh0, ksh1, iprim, jprim, kprim,
            omega, bas_ij_idx, ao_pair_loc, aux_offset, naux, nao); break;
    default: return 0;
    }
    return 1;
