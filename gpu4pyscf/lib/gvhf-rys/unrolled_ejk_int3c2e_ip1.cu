                    ...
                    int aux_offset, int naux, int nao)
{
    ...
    for (int pair_ij = shl_pair0+sp_id; pair_ij < shl_pair1+sp_id; pair_ij += BLOCK_SIZE) {
        ...
        __syncthreads();
        for (int ksh = ksh0+aux_id; ksh < ksh1; ksh += BLOCK_SIZE) {
            int k0;
            double *dm_tensor;
            ...
            for (int ijkp = 0; ijkp < ijkprim; ++ijkp) {
                ...
                for (int irys = 0; irys < nroots; ++irys) {
                    if (pair_ij < shl_pair1) {
                        ...
                        fzi = ai2 * trr_10z;
                        v_iz += fzi * prod_xy;
                        double hrr_121x = hrr_211x - xjxi * hrr_111x;
                        fxj = aj2 * hrr_121x;
                        fxj -= 1 * trr_11x;
                        v_jx += fxj * prod_yz;
                        double hrr_010y = trr_10y - yjyi * fac1;
                        ...
                        fzi = ai2 * trr_10z;
                        v_iz += fzi * prod_xy;
                        double hrr_021x = hrr_111x - xjxi * hrr_011x;
                        fxj = aj2 * hrr_021x;
                        fxj -= 1 * trr_01x;
                        v_jx += fxj * prod_yz;
                        double hrr_110y = trr_20y - yjyi * trr_10y;
                        ...
                        fxj = aj2 * hrr_110x;
                        v_jx += fxj * prod_yz;
                        double hrr_021y = hrr_111y - yjyi * hrr_011y;
                        fyj = aj2 * hrr_021y;
                        fyj -= 1 * trr_01y;
                        v_jy += fyj * prod_xz;
                        fzj = aj2 * hrr_010z;
                        ...
                        fxj = aj2 * hrr_010x;
                        v_jx += fxj * prod_yz;
                        double hrr_121y = hrr_211y - yjyi * hrr_111y;
                        fyj = aj2 * hrr_121y;
                        fyj -= 1 * trr_11y;
                        v_jy += fyj * prod_xz;
                        fzj = aj2 * hrr_010z;
                        ...
                        fyj = aj2 * hrr_010y;
                        v_jy += fyj * prod_xz;
                        double hrr_021z = hrr_111z - zjzi * hrr_011z;
                        fzj = aj2 * hrr_021z;
                        fzj -= 1 * trr_01z;
                        v_jz += fzj * prod_xy;
                        fxk = ak2 * trr_11x;
                        ...
                        fyj = aj2 * hrr_010y;
                        v_jy += fyj * prod_xz;
                        double hrr_121z = hrr_211z - zjzi * hrr_111z;
                        fzj = aj2 * hrr_121z;
                        fzj -= 1 * trr_11z;
                        v_jz += fzj * prod_xy;
                        fxk = ak2 * trr_01x;
