                    ...
                    uint32_t *pool, int *head, int workers)
{
    ...
    case 261: buflen = 4736 + iprim*jprim; LAUNCH_KERNEL(rys_jk_2021); break;
    case 275: LAUNCH_KERNEL(rys_k_2100); break;
    case 280: LAUNCH_KERNEL(rys_k_2110); break;
    case 281: buflen = 2944 + iprim*jprim; LAUNCH_KERNEL(rys_jk_2111); break;
    case 285: buflen = 4736 + iprim*jprim; LAUNCH_KERNEL(rys_jk_2120); break;
    case 300: LAUNCH_KERNEL(rys_k_2200); break;
    case 305: buflen = 4736 + iprim*jprim; LAUNCH_KERNEL(rys_jk_2210); break;
    case 375: LAUNCH_KERNEL(rys_k_3000); break;
    case 380: LAUNCH_KERNEL(rys_k_3010); break;
    case 381: buflen = 4352 + iprim*jprim; LAUNCH_KERNEL(rys_jk_3011); break;
    case 385: LAUNCH_KERNEL(rys_k_3020); break;
    case 400: LAUNCH_KERNEL(rys_k_3100); break;
    case 405: buflen = 4352 + iprim*jprim; LAUNCH_KERNEL(rys_jk_3110); break;
