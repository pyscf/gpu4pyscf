...
if __name__ == '__main__':
    ...
    print("")
    source_path = os.path.join(source_dir, 'df', 'organic', 'basis')
    target_path = os.path.join(target_dir, 'df', 'organic', 'basis')
    ...
    print("")
    source_path = os.path.join(source_dir, 'df', 'organic', 'xc')
    target_path = os.path.join(target_dir, 'df', 'organic', 'xc')
