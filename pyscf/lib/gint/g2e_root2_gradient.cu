                                               ...
                                               BasisProdOffsets offsets)
{
  ...
  eri_ij_lk[lstride+xyz_stride]=gout4;
  eri_ij_lk[2*lstride+xyz_stride]=gout5;
  eri_ij_lk[0+2*xyz_stride]=gout6;
  eri_ij_lk[lstride+2*xyz_stride]=gout7;
  eri_ij_lk[2*lstride+2*xyz_stride]=gout8;
  eri_ji_lk[0]=gout9;
  eri_ji_lk[lstride]=gout10;
  eri_ji_lk[2*lstride]=gout11;
  eri_ji_lk[0+xyz_stride]=gout12;
  eri_ji_lk[lstride+xyz_stride]=gout13;
  eri_ji_lk[2*lstride+xyz_stride]=gout14;
  eri_ji_lk[0+2*xyz_stride]=gout15;
  eri_ji_lk[lstride+2*xyz_stride]=gout16;
  eri_ji_lk[2*lstride+2*xyz_stride]=gout17;
                                               ...
                                               BasisProdOffsets offsets)
{
  ...
  eri_ij_lk[lstride+xyz_stride]=gout12;
  eri_ij_lk[kstride+lstride+xyz_stride]=gout13;
  eri_ij_lk[2*kstride+lstride+xyz_stride]=gout14;
  eri_ij_lk[2*lstride+xyz_stride]=gout15;
  eri_ij_lk[kstride+2*lstride+xyz_stride]=gout16;
  ...
  eri_ij_lk[2*kstride+lstride+2*xyz_stride]=gout23;
  eri_ij_lk[2*lstride+2*xyz_stride]=gout24;
  eri_ij_lk[kstride+2*lstride+2*xyz_stride]=gout25;
  eri_ij_lk[2*kstride+2*lstride+2*xyz_stride]=gout26;
  eri_ji_lk[0]=gout27;
  eri_ji_lk[kstride]=gout28;
  eri_ji_lk[2*kstride]=gout29;
  eri_ji_lk[lstride]=gout30;
  eri_ji_lk[kstride+lstride]=gout31;
  eri_ji_lk[2*kstride+lstride]=gout32;
  eri_ji_lk[2*lstride]=gout33;
  eri_ji_lk[kstride+2*lstride]=gout34;
  ...
  eri_ji_lk[lstride+xyz_stride]=gout39;
  eri_ji_lk[kstride+lstride+xyz_stride]=gout40;
  eri_ji_lk[2*kstride+lstride+xyz_stride]=gout41;
  eri_ji_lk[2*lstride+xyz_stride]=gout42;
  eri_ji_lk[kstride+2*lstride+xyz_stride]=gout43;
  ...
  eri_ji_lk[lstride+2*xyz_stride]=gout48;
  eri_ji_lk[kstride+lstride+2*xyz_stride]=gout49;
  eri_ji_lk[2*kstride+lstride+2*xyz_stride]=gout50;
  eri_ji_lk[2*lstride+2*xyz_stride]=gout51;
  eri_ji_lk[kstride+2*lstride+2*xyz_stride]=gout52;
                                               ...
                                               BasisProdOffsets offsets)
{
  ...
  eri_ij_lk[lstride+xyz_stride]=gout7;
  eri_ij_lk[2*lstride+xyz_stride]=gout8;
  eri_ij_lk[3*lstride+xyz_stride]=gout9;
  eri_ij_lk[4*lstride+xyz_stride]=gout10;
  eri_ij_lk[5*lstride+xyz_stride]=gout11;
  eri_ij_lk[0+2*xyz_stride]=gout12;
  eri_ij_lk[lstride+2*xyz_stride]=gout13;
  eri_ij_lk[2*lstride+2*xyz_stride]=gout14;
  eri_ij_lk[3*lstride+2*xyz_stride]=gout15;
  eri_ij_lk[4*lstride+2*xyz_stride]=gout16;
  eri_ij_lk[5*lstride+2*xyz_stride]=gout17;
  eri_ji_lk[0]=gout18;
  eri_ji_lk[lstride]=gout19;
  eri_ji_lk[2*lstride]=gout20;
  eri_ji_lk[3*lstride]=gout21;
  eri_ji_lk[4*lstride]=gout22;
  eri_ji_lk[5*lstride]=gout23;
  eri_ji_lk[0+xyz_stride]=gout24;
  eri_ji_lk[lstride+xyz_stride]=gout25;
  eri_ji_lk[2*lstride+xyz_stride]=gout26;
  eri_ji_lk[3*lstride+xyz_stride]=gout27;
  eri_ji_lk[4*lstride+xyz_stride]=gout28;
  eri_ji_lk[5*lstride+xyz_stride]=gout29;
  eri_ji_lk[0+2*xyz_stride]=gout30;
  eri_ji_lk[lstride+2*xyz_stride]=gout31;
  eri_ji_lk[2*lstride+2*xyz_stride]=gout32;
  eri_ji_lk[3*lstride+2*xyz_stride]=gout33;
  eri_ji_lk[4*lstride+2*xyz_stride]=gout34;
  eri_ji_lk[5*lstride+2*xyz_stride]=gout35;
                                               ...
                                               BasisProdOffsets offsets)
{
  ...
  eri_ji[0]=gout9;
  eri_ji[jstride]=gout10;
  eri_ji[2*jstride]=gout11;
  eri_ji[0+xyz_stride]=gout12;
  eri_ji[jstride+xyz_stride]=gout13;
  eri_ji[2*jstride+xyz_stride]=gout14;
  eri_ji[0+2*xyz_stride]=gout15;
  eri_ji[jstride+2*xyz_stride]=gout16;
  eri_ji[2*jstride+2*xyz_stride]=gout17;
  eri_ij_lk[0]=gout0;
  eri_ij_lk[1]=gout1;
  eri_ij_lk[2]=gout2;
  eri_ij_lk[0+xyz_stride]=gout3;
  ...
  eri_ji_lk[0]=gout9;
  eri_ji_lk[jstride]=gout10;
  eri_ji_lk[2*jstride]=gout11;
  eri_ji_lk[0+xyz_stride]=gout12;
  eri_ji_lk[jstride+xyz_stride]=gout13;
  eri_ji_lk[2*jstride+xyz_stride]=gout14;
  eri_ji_lk[0+2*xyz_stride]=gout15;
  eri_ji_lk[jstride+2*xyz_stride]=gout16;
  eri_ji_lk[2*jstride+2*xyz_stride]=gout17;
                                               ...
                                               BasisProdOffsets offsets)
{
  ...
  eri_ji[jstride]=gout30;
  eri_ji[jstride+kstride]=gout31;
  eri_ji[jstride+2*kstride]=gout32;
  eri_ji[2*jstride]=gout33;
  eri_ji[2*jstride+kstride]=gout34;
  eri_ji[2*jstride+2*kstride]=gout35;
  eri_ji[0+xyz_stride]=gout36;
  eri_ji[kstride+xyz_stride]=gout37;
  eri_ji[2*kstride+xyz_stride]=gout38;
  eri_ji[jstride+xyz_stride]=gout39;
  eri_ji[jstride+kstride+xyz_stride]=gout40;
  eri_ji[jstride+2*kstride+xyz_stride]=gout41;
  eri_ji[2*jstride+xyz_stride]=gout42;
  eri_ji[2*jstride+kstride+xyz_stride]=gout43;
  eri_ji[2*jstride+2*kstride+xyz_stride]=gout44;
  eri_ji[0+2*xyz_stride]=gout45;
  eri_ji[kstride+2*xyz_stride]=gout46;
  eri_ji[2*kstride+2*xyz_stride]=gout47;
  eri_ji[jstride+2*xyz_stride]=gout48;
  eri_ji[jstride+kstride+2*xyz_stride]=gout49;
  eri_ji[jstride+2*kstride+2*xyz_stride]=gout50;
  eri_ji[2*jstride+2*xyz_stride]=gout51;
  eri_ji[2*jstride+kstride+2*xyz_stride]=gout52;
  eri_ji[2*jstride+2*kstride+2*xyz_stride]=gout53;
  eri_ij_lk[0]=gout0;
  eri_ij_lk[lstride]=gout1;
  eri_ij_lk[2*lstride]=gout2;
  eri_ij_lk[1]=gout3;
  ...
  eri_ij_lk[1+lstride+xyz_stride]=gout13;
  eri_ij_lk[1+2*lstride+xyz_stride]=gout14;
  eri_ij_lk[2+xyz_stride]=gout15;
  eri_ij_lk[2+lstride+xyz_stride]=gout16;
  eri_ij_lk[2+2*lstride+xyz_stride]=gout17;
  eri_ij_lk[0+2*xyz_stride]=gout18;
  eri_ij_lk[lstride+2*xyz_stride]=gout19;
  eri_ij_lk[2*lstride+2*xyz_stride]=gout20;
  eri_ij_lk[1+2*xyz_stride]=gout21;
  eri_ij_lk[1+lstride+2*xyz_stride]=gout22;
  eri_ij_lk[1+2*lstride+2*xyz_stride]=gout23;
  eri_ij_lk[2+2*xyz_stride]=gout24;
  eri_ij_lk[2+lstride+2*xyz_stride]=gout25;
  eri_ij_lk[2+2*lstride+2*xyz_stride]=gout26;
  eri_ji_lk[0]=gout27;
  eri_ji_lk[lstride]=gout28;
  eri_ji_lk[2*lstride]=gout29;
  eri_ji_lk[jstride]=gout30;
  eri_ji_lk[jstride+lstride]=gout31;
  eri_ji_lk[jstride+2*lstride]=gout32;
  eri_ji_lk[2*jstride]=gout33;
  eri_ji_lk[2*jstride+lstride]=gout34;
  eri_ji_lk[2*jstride+2*lstride]=gout35;
  eri_ji_lk[0+xyz_stride]=gout36;
  eri_ji_lk[lstride+xyz_stride]=gout37;
  eri_ji_lk[2*lstride+xyz_stride]=gout38;
  eri_ji_lk[jstride+xyz_stride]=gout39;
  eri_ji_lk[jstride+lstride+xyz_stride]=gout40;
  eri_ji_lk[jstride+2*lstride+xyz_stride]=gout41;
  eri_ji_lk[2*jstride+xyz_stride]=gout42;
  eri_ji_lk[2*jstride+lstride+xyz_stride]=gout43;
  eri_ji_lk[2*jstride+2*lstride+xyz_stride]=gout44;
  eri_ji_lk[0+2*xyz_stride]=gout45;
  eri_ji_lk[lstride+2*xyz_stride]=gout46;
  eri_ji_lk[2*lstride+2*xyz_stride]=gout47;
  eri_ji_lk[jstride+2*xyz_stride]=gout48;
  eri_ji_lk[jstride+lstride+2*xyz_stride]=gout49;
  eri_ji_lk[jstride+2*lstride+2*xyz_stride]=gout50;
  eri_ji_lk[2*jstride+2*xyz_stride]=gout51;
  eri_ji_lk[2*jstride+lstride+2*xyz_stride]=gout52;
  eri_ji_lk[2*jstride+2*lstride+2*xyz_stride]=gout53;
                                               ...
                                               BasisProdOffsets offsets)
{
  ...
  eri_ji[2*jstride]=gout33;
  eri_ji[1+2*jstride]=gout34;
  eri_ji[2+2*jstride]=gout35;
  eri_ji[0+xyz_stride]=gout36;
  eri_ji[1+xyz_stride]=gout37;
  eri_ji[2+xyz_stride]=gout38;
  eri_ji[jstride+xyz_stride]=gout39;
  eri_ji[1+jstride+xyz_stride]=gout40;
  eri_ji[2+jstride+xyz_stride]=gout41;
  eri_ji[2*jstride+xyz_stride]=gout42;
  eri_ji[1+2*jstride+xyz_stride]=gout43;
  eri_ji[2+2*jstride+xyz_stride]=gout44;
  eri_ji[0+2*xyz_stride]=gout45;
  eri_ji[1+2*xyz_stride]=gout46;
  eri_ji[2+2*xyz_stride]=gout47;
  eri_ji[jstride+2*xyz_stride]=gout48;
  eri_ji[1+jstride+2*xyz_stride]=gout49;
  eri_ji[2+jstride+2*xyz_stride]=gout50;
  eri_ji[2*jstride+2*xyz_stride]=gout51;
  eri_ji[1+2*jstride+2*xyz_stride]=gout52;
  ...
  eri_ji_lk[2*jstride]=gout33;
  eri_ji_lk[1+2*jstride]=gout34;
  eri_ji_lk[2+2*jstride]=gout35;
  eri_ji_lk[0+xyz_stride]=gout36;
  eri_ji_lk[1+xyz_stride]=gout37;
  eri_ji_lk[2+xyz_stride]=gout38;
  eri_ji_lk[jstride+xyz_stride]=gout39;
  eri_ji_lk[1+jstride+xyz_stride]=gout40;
  eri_ji_lk[2+jstride+xyz_stride]=gout41;
  eri_ji_lk[2*jstride+xyz_stride]=gout42;
  eri_ji_lk[1+2*jstride+xyz_stride]=gout43;
  eri_ji_lk[2+2*jstride+xyz_stride]=gout44;
  eri_ji_lk[0+2*xyz_stride]=gout45;
  eri_ji_lk[1+2*xyz_stride]=gout46;
  eri_ji_lk[2+2*xyz_stride]=gout47;
  eri_ji_lk[jstride+2*xyz_stride]=gout48;
  eri_ji_lk[1+jstride+2*xyz_stride]=gout49;
  eri_ji_lk[2+jstride+2*xyz_stride]=gout50;
  eri_ji_lk[2*jstride+2*xyz_stride]=gout51;
  eri_ji_lk[1+2*jstride+2*xyz_stride]=gout52;
                                               ...
                                               BasisProdOffsets offsets)
{
  ...
  eri_ji[0]=gout18;
  eri_ji[jstride]=gout19;
  eri_ji[2*jstride]=gout20;
  eri_ji[3*jstride]=gout21;
  eri_ji[4*jstride]=gout22;
  eri_ji[5*jstride]=gout23;
  eri_ji[0+xyz_stride]=gout24;
  eri_ji[jstride+xyz_stride]=gout25;
  eri_ji[2*jstride+xyz_stride]=gout26;
  eri_ji[3*jstride+xyz_stride]=gout27;
  eri_ji[4*jstride+xyz_stride]=gout28;
  eri_ji[5*jstride+xyz_stride]=gout29;
  eri_ji[0+2*xyz_stride]=gout30;
  eri_ji[jstride+2*xyz_stride]=gout31;
  eri_ji[2*jstride+2*xyz_stride]=gout32;
  eri_ji[3*jstride+2*xyz_stride]=gout33;
  eri_ji[4*jstride+2*xyz_stride]=gout34;
  eri_ji[5*jstride+2*xyz_stride]=gout35;
  eri_ij_lk[0]=gout0;
  eri_ij_lk[1]=gout1;
  eri_ij_lk[2]=gout2;
  eri_ij_lk[3]=gout3;
  ...
  eri_ji_lk[0]=gout18;
  eri_ji_lk[jstride]=gout19;
  eri_ji_lk[2*jstride]=gout20;
  eri_ji_lk[3*jstride]=gout21;
  eri_ji_lk[4*jstride]=gout22;
  eri_ji_lk[5*jstride]=gout23;
  eri_ji_lk[0+xyz_stride]=gout24;
  eri_ji_lk[jstride+xyz_stride]=gout25;
  eri_ji_lk[2*jstride+xyz_stride]=gout26;
  eri_ji_lk[3*jstride+xyz_stride]=gout27;
  eri_ji_lk[4*jstride+xyz_stride]=gout28;
  eri_ji_lk[5*jstride+xyz_stride]=gout29;
  eri_ji_lk[0+2*xyz_stride]=gout30;
  eri_ji_lk[jstride+2*xyz_stride]=gout31;
  eri_ji_lk[2*jstride+2*xyz_stride]=gout32;
  eri_ji_lk[3*jstride+2*xyz_stride]=gout33;
  eri_ji_lk[4*jstride+2*xyz_stride]=gout34;
  eri_ji_lk[5*jstride+2*xyz_stride]=gout35;
