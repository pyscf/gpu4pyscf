  ...
  switch (nrys_roots) {
    ...
    case 2:
      ...
      switch (type_ijkl) {
        ...
        case (0<<6)|(0<<4)|(2<<2)|0: GINTint2e_jk_kernel_nabla1i_0020<<<blocks, threads>>>(*jk, *offsets); break;
        case (1<<6)|(0<<4)|(0<<2)|0: GINTint2e_jk_kernel_nabla1i_1000<<<blocks, threads>>>(*jk, *offsets); break;
        case (1<<6)|(0<<4)|(1<<2)|0: GINTint2e_jk_kernel_nabla1i_1010<<<blocks, threads>>>(*jk, *offsets); break;
        case (1<<6)|(1<<4)|(0<<2)|0: GINTint2e_jk_kernel_nabla1i_1100<<<blocks, threads>>>(*jk, *offsets); break;
        case (2<<6)|(0<<4)|(0<<2)|0: GINTint2e_jk_kernel_nabla1i_2000<<<blocks, threads>>>(*jk, *offsets); break;
        default:
    ...
    case 3:
      ...
      switch (type_ijkl) {
        ...
        case (0<<6)|(0<<4)|(3<<2)|0: GINTint2e_jk_kernel_nabla1i_0030<<<blocks, threads>>>(*jk, *offsets); break;
        case (0<<6)|(0<<4)|(3<<2)|1: GINTint2e_jk_kernel_nabla1i_0031<<<blocks, threads>>>(*jk, *offsets); break;
        case (1<<6)|(0<<4)|(1<<2)|1: GINTint2e_jk_kernel_nabla1i_1011<<<blocks, threads>>>(*jk, *offsets); break;
        case (1<<6)|(0<<4)|(2<<2)|0: GINTint2e_jk_kernel_nabla1i_1020<<<blocks, threads>>>(*jk, *offsets); break;
        case (1<<6)|(0<<4)|(2<<2)|1: GINTint2e_jk_kernel_nabla1i_1021<<<blocks, threads>>>(*jk, *offsets); break;
        case (1<<6)|(0<<4)|(3<<2)|0: GINTint2e_jk_kernel_nabla1i_1030<<<blocks, threads>>>(*jk, *offsets); break;
        case (1<<6)|(1<<4)|(1<<2)|0: GINTint2e_jk_kernel_nabla1i_1110<<<blocks, threads>>>(*jk, *offsets); break;
        case (1<<6)|(1<<4)|(1<<2)|1: GINTint2e_jk_kernel_nabla1i_1111<<<blocks, threads>>>(*jk, *offsets); break;
        case (1<<6)|(1<<4)|(2<<2)|0: GINTint2e_jk_kernel_nabla1i_1120<<<blocks, threads>>>(*jk, *offsets); break;
        case (2<<6)|(0<<4)|(1<<2)|0: GINTint2e_jk_kernel_nabla1i_2010<<<blocks, threads>>>(*jk, *offsets); break;
        case (2<<6)|(0<<4)|(1<<2)|1: GINTint2e_jk_kernel_nabla1i_2011<<<blocks, threads>>>(*jk, *offsets); break;
        case (2<<6)|(0<<4)|(2<<2)|0: GINTint2e_jk_kernel_nabla1i_2020<<<blocks, threads>>>(*jk, *offsets); break;
        case (2<<6)|(1<<4)|(0<<2)|0: GINTint2e_jk_kernel_nabla1i_2100<<<blocks, threads>>>(*jk, *offsets); break;
        case (2<<6)|(1<<4)|(1<<2)|0: GINTint2e_jk_kernel_nabla1i_2110<<<blocks, threads>>>(*jk, *offsets); break;
        case (2<<6)|(2<<4)|(0<<2)|0: GINTint2e_jk_kernel_nabla1i_2200<<<blocks, threads>>>(*jk, *offsets); break;
        case (3<<6)|(0<<4)|(0<<2)|0: GINTint2e_jk_kernel_nabla1i_3000<<<blocks, threads>>>(*jk, *offsets); break;
        case (3<<6)|(0<<4)|(1<<2)|0: GINTint2e_jk_kernel_nabla1i_3010<<<blocks, threads>>>(*jk, *offsets); break;
        case (3<<6)|(1<<4)|(0<<2)|0: GINTint2e_jk_kernel_nabla1i_3100<<<blocks, threads>>>(*jk, *offsets); break;
        default:
