...
__global__
static void GINTint2e_jk_kernel_nabla1i_0010(JKMatrix jk,
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        double weightedalpha = alpha * weight0;
        double weightedbeta = beta * weight0;
        double u2 = a0 * root0;
        ...
        gout0 += (2*weightedalpha*g1);
        gout1 += (2*weightedalpha*C00x) * (D00y);
        gout2 += (2*weightedalpha*C00x) * (D00z);
        gout3 += (D00x) * (2*weightedalpha*C00y);
        gout4 += (2*weightedalpha*g6);
        gout5 += (2*weightedalpha*C00y) * (D00z);
        gout6 += (D00x) * (2*weightedalpha*C00z);
        gout7 += (D00y) * (2*weightedalpha*C00z);
        gout8 += (2*weightedalpha*g11);
        gout9 += (2*weightedbeta*g4);
        gout10 += (2*weightedbeta*g2) * (D00y);
        gout11 += (2*weightedbeta*g2) * (D00z);
        gout12 += (D00x) * (2*weightedbeta*g7);
        gout13 += (2*weightedbeta*g9);
        gout14 += (2*weightedbeta*g7) * (D00z);
        gout15 += (D00x) * (2*weightedbeta*g12);
        gout16 += (D00y) * (2*weightedbeta*g12);
        gout17 += (2*weightedbeta*g14);
      }
    } }
...
__global__
static void GINTint2e_jk_kernel_nabla1i_0011(JKMatrix jk,
                                             BasisProdOffsets offsets)
{
  int ntasks_ij = offsets.ntasks_ij;
  int ntasks_kl = offsets.ntasks_kl;
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        gout0 += (2*weightedalpha*g15);
        gout1 += (2*weightedalpha*g1) * (g25);
        gout2 += (2*weightedalpha*g1) * (g45);
        gout3 += (2*weightedalpha*g7) * (D00y);
        gout4 += (2*weightedalpha*C00x) * (g29);
        gout5 += (2*weightedalpha*C00x) * (D00y) * (g45);
        gout6 += (2*weightedalpha*g7) * (D00z);
        gout7 += (2*weightedalpha*C00x) * (g25) * (D00z);
        gout8 += (2*weightedalpha*C00x) * (g49);
        gout9 += (g9) * (2*weightedalpha*C00y);
        gout10 += (D00x) * (2*weightedalpha*g27);
        gout11 += (D00x) * (2*weightedalpha*C00y) * (g45);
        gout12 += (g5) * (2*weightedalpha*g21);
        gout13 += (2*weightedalpha*g35);
        gout14 += (2*weightedalpha*g21) * (g45);
        gout15 += (g5) * (2*weightedalpha*C00y) * (D00z);
        gout16 += (2*weightedalpha*g27) * (D00z);
        gout17 += (2*weightedalpha*C00y) * (g49);
        gout18 += (g9) * (2*weightedalpha*C00z);
        gout19 += (D00x) * (g25) * (2*weightedalpha*C00z);
        gout20 += (D00x) * (2*weightedalpha*g47);
        gout21 += (g5) * (D00y) * (2*weightedalpha*C00z);
        gout22 += (g29) * (2*weightedalpha*C00z);
        gout23 += (D00y) * (2*weightedalpha*g47);
        gout24 += (g5) * (2*weightedalpha*g41);
        gout25 += (g25) * (2*weightedalpha*g41);
        gout26 += (2*weightedalpha*g55);
        gout27 += (2*weightedbeta*g19);
        gout28 += (2*weightedbeta*g4) * (g25);
        gout29 += (2*weightedbeta*g4) * (g45);
        gout30 += (2*weightedbeta*g17) * (D00y);
        gout31 += (2*weightedbeta*g2) * (g29);
        gout32 += (2*weightedbeta*g2) * (D00y) * (g45);
        gout33 += (2*weightedbeta*g17) * (D00z);
        gout34 += (2*weightedbeta*g2) * (g25) * (D00z);
        gout35 += (2*weightedbeta*g2) * (g49);
        gout36 += (g9) * (2*weightedbeta*g22);
        gout37 += (D00x) * (2*weightedbeta*g37);
        gout38 += (D00x) * (2*weightedbeta*g22) * (g45);
        gout39 += (g5) * (2*weightedbeta*g24);
        gout40 += (2*weightedbeta*g39);
        gout41 += (2*weightedbeta*g24) * (g45);
        gout42 += (g5) * (2*weightedbeta*g22) * (D00z);
        gout43 += (2*weightedbeta*g37) * (D00z);
        gout44 += (2*weightedbeta*g22) * (g49);
        gout45 += (g9) * (2*weightedbeta*g42);
        gout46 += (D00x) * (g25) * (2*weightedbeta*g42);
        gout47 += (D00x) * (2*weightedbeta*g57);
        gout48 += (g5) * (D00y) * (2*weightedbeta*g42);
        gout49 += (g29) * (2*weightedbeta*g42);
        gout50 += (D00y) * (2*weightedbeta*g57);
        gout51 += (g5) * (2*weightedbeta*g44);
        gout52 += (g25) * (2*weightedbeta*g44);
        gout53 += (2*weightedbeta*g59);
      }
    } }
...
__global__
static void GINTint2e_jk_kernel_nabla1i_0020(JKMatrix jk,
                                             BasisProdOffsets offsets)
{
  int ntasks_ij = offsets.ntasks_ij;
  int ntasks_kl = offsets.ntasks_kl;
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        gout0 += (2*weightedalpha*g5);
        gout1 += (2*weightedalpha*g1) * (D00y);
        gout2 += (2*weightedalpha*g1) * (D00z);
        gout3 += (2*weightedalpha*C00x) * (g13);
        gout4 += (2*weightedalpha*C00x) * (D00y) * (D00z);
        gout5 += (2*weightedalpha*C00x) * (g24);
        gout6 += (g2) * (2*weightedalpha*C00y);
        gout7 += (D00x) * (2*weightedalpha*g12);
        gout8 += (D00x) * (2*weightedalpha*C00y) * (D00z);
        gout9 += (2*weightedalpha*g16);
        gout10 += (2*weightedalpha*g12) * (D00z);
        gout11 += (2*weightedalpha*C00y) * (g24);
        gout12 += (g2) * (2*weightedalpha*C00z);
        gout13 += (D00x) * (D00y) * (2*weightedalpha*C00z);
        gout14 += (D00x) * (2*weightedalpha*g23);
        gout15 += (g13) * (2*weightedalpha*C00z);
        gout16 += (D00y) * (2*weightedalpha*g23);
        gout17 += (2*weightedalpha*g27);
        gout18 += (2*weightedbeta*g10);
        gout19 += (2*weightedbeta*g8) * (D00y);
        gout20 += (2*weightedbeta*g8) * (D00z);
        gout21 += (2*weightedbeta*g6) * (g13);
        gout22 += (2*weightedbeta*g6) * (D00y) * (D00z);
        gout23 += (2*weightedbeta*g6) * (g24);
        gout24 += (g2) * (2*weightedbeta*g17);
        gout25 += (D00x) * (2*weightedbeta*g19);
        gout26 += (D00x) * (2*weightedbeta*g17) * (D00z);
        gout27 += (2*weightedbeta*g21);
        gout28 += (2*weightedbeta*g19) * (D00z);
        gout29 += (2*weightedbeta*g17) * (g24);
        gout30 += (g2) * (2*weightedbeta*g28);
        gout31 += (D00x) * (D00y) * (2*weightedbeta*g28);
        gout32 += (D00x) * (2*weightedbeta*g30);
        gout33 += (g13) * (2*weightedbeta*g28);
        gout34 += (D00y) * (2*weightedbeta*g30);
        gout35 += (2*weightedbeta*g32);
      }
    } }
...
__global__
static void GINTint2e_jk_kernel_nabla1i_1000(JKMatrix jk,
                                             BasisProdOffsets offsets)
{
  int ntasks_ij = offsets.ntasks_ij;
  int ntasks_kl = offsets.ntasks_kl;
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        gout0 += (-1 + 2*weightedalpha*g0);
        gout1 += (2*weightedalpha*C00x) * (C00y);
        gout2 += (2*weightedalpha*C00x) * (C00z);
        gout3 += (C00x) * (2*weightedalpha*C00y);
        gout4 += (-1 + 2*weightedalpha*g4);
        gout5 += (2*weightedalpha*C00y) * (C00z);
        gout6 += (C00x) * (2*weightedalpha*C00z);
        gout7 += (C00y) * (2*weightedalpha*C00z);
        gout8 += (-1 + 2*weightedalpha*g8);
        gout9 += (2*weightedbeta*g3);
        gout10 += (2*weightedbeta*g1) * (C00y);
        gout11 += (2*weightedbeta*g1) * (C00z);
        gout12 += (C00x) * (2*weightedbeta*g5);
        gout13 += (2*weightedbeta*g7);
        gout14 += (2*weightedbeta*g5) * (C00z);
        gout15 += (C00x) * (2*weightedbeta*g9);
        gout16 += (C00y) * (2*weightedbeta*g9);
        gout17 += (2*weightedbeta*g11);
      }
    } }
...
__global__
static void GINTint2e_jk_kernel_nabla1i_1010(JKMatrix jk,
                                             BasisProdOffsets offsets)
{
  int ntasks_ij = offsets.ntasks_ij;
  int ntasks_kl = offsets.ntasks_kl;
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        gout0 += (-D00x + 2*weightedalpha*g5);
        gout1 += (-1 + 2*weightedalpha*g0) * (D00y);
        gout2 += (-1 + 2*weightedalpha*g0) * (D00z);
        gout3 += (2*weightedalpha*g2) * (C00y);
        gout4 += (2*weightedalpha*C00x) * (g18);
        gout5 += (2*weightedalpha*C00x) * (C00y) * (D00z);
        gout6 += (2*weightedalpha*g2) * (C00z);
        gout7 += (2*weightedalpha*C00x) * (D00y) * (C00z);
        gout8 += (2*weightedalpha*C00x) * (g34);
        gout9 += (g2) * (2*weightedalpha*C00y);
        gout10 += (C00x) * (2*weightedalpha*g18);
        gout11 += (C00x) * (2*weightedalpha*C00y) * (D00z);
        gout12 += (D00x) * (-1 + 2*weightedalpha*g16);
        gout13 += (-D00y + 2*weightedalpha*g21);
        gout14 += (-1 + 2*weightedalpha*g16) * (D00z);
        gout15 += (D00x) * (2*weightedalpha*C00y) * (C00z);
        gout16 += (2*weightedalpha*g18) * (C00z);
        gout17 += (2*weightedalpha*C00y) * (g34);
        gout18 += (g2) * (2*weightedalpha*C00z);
        gout19 += (C00x) * (D00y) * (2*weightedalpha*C00z);
        gout20 += (C00x) * (2*weightedalpha*g34);
        gout21 += (D00x) * (C00y) * (2*weightedalpha*C00z);
        gout22 += (g18) * (2*weightedalpha*C00z);
        gout23 += (C00y) * (2*weightedalpha*g34);
        gout24 += (D00x) * (-1 + 2*weightedalpha*g32);
        gout25 += (D00y) * (-1 + 2*weightedalpha*g32);
        gout26 += (-D00z + 2*weightedalpha*g37);
        gout27 += (2*weightedbeta*g15);
        gout28 += (2*weightedbeta*g8) * (D00y);
        gout29 += (2*weightedbeta*g8) * (D00z);
        gout30 += (2*weightedbeta*g10) * (C00y);
        gout31 += (2*weightedbeta*g6) * (g18);
        gout32 += (2*weightedbeta*g6) * (C00y) * (D00z);
        gout33 += (2*weightedbeta*g10) * (C00z);
        gout34 += (2*weightedbeta*g6) * (D00y) * (C00z);
        gout35 += (2*weightedbeta*g6) * (g34);
        gout36 += (g2) * (2*weightedbeta*g22);
        gout37 += (C00x) * (2*weightedbeta*g26);
        gout38 += (C00x) * (2*weightedbeta*g22) * (D00z);
        gout39 += (D00x) * (2*weightedbeta*g24);
        gout40 += (2*weightedbeta*g31);
        gout41 += (2*weightedbeta*g24) * (D00z);
        gout42 += (D00x) * (2*weightedbeta*g22) * (C00z);
        gout43 += (2*weightedbeta*g26) * (C00z);
        gout44 += (2*weightedbeta*g22) * (g34);
        gout45 += (g2) * (2*weightedbeta*g38);
        gout46 += (C00x) * (D00y) * (2*weightedbeta*g38);
        gout47 += (C00x) * (2*weightedbeta*g42);
        gout48 += (D00x) * (C00y) * (2*weightedbeta*g38);
        gout49 += (g18) * (2*weightedbeta*g38);
        gout50 += (C00y) * (2*weightedbeta*g42);
        gout51 += (D00x) * (2*weightedbeta*g40);
        gout52 += (D00y) * (2*weightedbeta*g40);
        gout53 += (2*weightedbeta*g47);
      }
    } }
...
__global__
static void GINTint2e_jk_kernel_nabla1i_1100(JKMatrix jk,
                                             BasisProdOffsets offsets)
{
  int ntasks_ij = offsets.ntasks_ij;
  int ntasks_kl = offsets.ntasks_kl;
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        gout0 += (-g1 + 2*weightedalpha*g6);
        gout1 += (-1 + 2*weightedalpha*g0) * (g12);
        gout2 += (-1 + 2*weightedalpha*g0) * (g23);
        gout3 += (2*weightedalpha*g3) * (C00y);
        gout4 += (2*weightedalpha*C00x) * (g14);
        gout5 += (2*weightedalpha*C00x) * (C00y) * (g23);
        gout6 += (2*weightedalpha*g3) * (C00z);
        gout7 += (2*weightedalpha*C00x) * (g12) * (C00z);
        gout8 += (2*weightedalpha*C00x) * (g25);
        gout9 += (g3) * (2*weightedalpha*C00y);
        gout10 += (C00x) * (2*weightedalpha*g14);
        gout11 += (C00x) * (2*weightedalpha*C00y) * (g23);
        gout12 += (g1) * (-1 + 2*weightedalpha*g11);
        gout13 += (-g12 + 2*weightedalpha*g17);
        gout14 += (-1 + 2*weightedalpha*g11) * (g23);
        gout15 += (g1) * (2*weightedalpha*C00y) * (C00z);
        gout16 += (2*weightedalpha*g14) * (C00z);
        gout17 += (2*weightedalpha*C00y) * (g25);
        gout18 += (g3) * (2*weightedalpha*C00z);
        gout19 += (C00x) * (g12) * (2*weightedalpha*C00z);
        gout20 += (C00x) * (2*weightedalpha*g25);
        gout21 += (g1) * (C00y) * (2*weightedalpha*C00z);
        gout22 += (g14) * (2*weightedalpha*C00z);
        gout23 += (C00y) * (2*weightedalpha*g25);
        gout24 += (g1) * (-1 + 2*weightedalpha*g22);
        gout25 += (g12) * (-1 + 2*weightedalpha*g22);
        gout26 += (-g23 + 2*weightedalpha*g28);
        gout27 += (-C00x + 2*weightedbeta*g10);
        gout28 += (2*weightedbeta*g3) * (g12);
        gout29 += (2*weightedbeta*g3) * (g23);
        gout30 += (-1 + 2*weightedbeta*g7) * (C00y);
        gout31 += (2*weightedbeta*g1) * (g14);
        gout32 += (2*weightedbeta*g1) * (C00y) * (g23);
        gout33 += (-1 + 2*weightedbeta*g7) * (C00z);
        gout34 += (2*weightedbeta*g1) * (g12) * (C00z);
        gout35 += (2*weightedbeta*g1) * (g25);
        gout36 += (g3) * (2*weightedbeta*g12);
        gout37 += (C00x) * (-1 + 2*weightedbeta*g18);
        gout38 += (C00x) * (2*weightedbeta*g12) * (g23);
        gout39 += (g1) * (2*weightedbeta*g14);
        gout40 += (-C00y + 2*weightedbeta*g21);
        gout41 += (2*weightedbeta*g14) * (g23);
        gout42 += (g1) * (2*weightedbeta*g12) * (C00z);
        gout43 += (-1 + 2*weightedbeta*g18) * (C00z);
        gout44 += (2*weightedbeta*g12) * (g25);
        gout45 += (g3) * (2*weightedbeta*g23);
        gout46 += (C00x) * (g12) * (2*weightedbeta*g23);
        gout47 += (C00x) * (-1 + 2*weightedbeta*g29);
        gout48 += (g1) * (C00y) * (2*weightedbeta*g23);
        gout49 += (g14) * (2*weightedbeta*g23);
        gout50 += (C00y) * (-1 + 2*weightedbeta*g29);
        gout51 += (g1) * (2*weightedbeta*g25);
        gout52 += (g12) * (2*weightedbeta*g25);
        gout53 += (-C00z + 2*weightedbeta*g32);
      }
    } }
...
__global__
static void GINTint2e_jk_kernel_nabla1i_2000(JKMatrix jk,
                                             BasisProdOffsets offsets)
{
  int ntasks_ij = offsets.ntasks_ij;
  int ntasks_kl = offsets.ntasks_kl;
  ...
  for (ij = prim_ij0; ij < prim_ij1; ++ij) {
    for (kl = prim_kl0; kl < prim_kl1; ++kl) {
      ...
      for (irys = 0; irys < 2; ++irys) {
        ...
        gout0 += (-2*C00x + 2*weightedalpha*g2);
        gout1 += (-1 + 2*weightedalpha*g0) * (C00y);
        gout2 += (-1 + 2*weightedalpha*g0) * (C00z);
        gout3 += (2*weightedalpha*C00x) * (g8);
        gout4 += (2*weightedalpha*C00x) * (C00y) * (C00z);
        gout5 += (2*weightedalpha*C00x) * (g16);
        gout6 += (g0) * (2*weightedalpha*C00y);
        gout7 += (C00x) * (-1 + 2*weightedalpha*g8);
        gout8 += (C00x) * (2*weightedalpha*C00y) * (C00z);
        gout9 += (-2*C00y + 2*weightedalpha*g10);
        gout10 += (-1 + 2*weightedalpha*g8) * (C00z);
        gout11 += (2*weightedalpha*C00y) * (g16);
        gout12 += (g0) * (2*weightedalpha*C00z);
        gout13 += (C00x) * (C00y) * (2*weightedalpha*C00z);
        gout14 += (C00x) * (-1 + 2*weightedalpha*g16);
        gout15 += (g8) * (2*weightedalpha*C00z);
        gout16 += (C00y) * (-1 + 2*weightedalpha*g16);
        gout17 += (-2*C00z + 2*weightedalpha*g18);
        gout18 += (2*weightedbeta*g7);
        gout19 += (2*weightedbeta*g5) * (C00y);
        gout20 += (2*weightedbeta*g5) * (C00z);
        gout21 += (2*weightedbeta*g3) * (g8);
        gout22 += (2*weightedbeta*g3) * (C00y) * (C00z);
        gout23 += (2*weightedbeta*g3) * (g16);
        gout24 += (g0) * (2*weightedbeta*g11);
        gout25 += (C00x) * (2*weightedbeta*g13);
        gout26 += (C00x) * (2*weightedbeta*g11) * (C00z);
        gout27 += (2*weightedbeta*g15);
        gout28 += (2*weightedbeta*g13) * (C00z);
        gout29 += (2*weightedbeta*g11) * (g16);
        gout30 += (g0) * (2*weightedbeta*g19);
        gout31 += (C00x) * (C00y) * (2*weightedbeta*g19);
        gout32 += (C00x) * (2*weightedbeta*g21);
        gout33 += (g8) * (2*weightedbeta*g19);
        gout34 += (C00y) * (2*weightedbeta*g21);
        gout35 += (2*weightedbeta*g23);
      }
    } }
